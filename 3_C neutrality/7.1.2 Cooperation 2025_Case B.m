...
save('H:\Global PV and wind\ANS\EF_2025_2040CaseB.mat','EF','-v7.3')  % t CO2/kWh
...
save('H:\Global PV and wind\ANS\inv_total_cou_PW_noconn_2025_2040CaseB.mat','inv_total_cou','-v7.3')  % million $,total cost
save('H:\Global PV and wind\ANS\inv_cou_PW_noconn_2025_2040CaseB.mat','inv_cou','-v7.3')  % TWh/year
nn_c = nn_c+1;

r_power_coop_notech_nopowertrans = r_power_coop;
Inv_pvwind_mineral(1,1) = inv;% million USD

r_power_coop_notech_nopowertrans2025 = zeros(numpowerunit_all,1);
power_coop_notech_nopowertrans2025 = zeros(numpowerunit_all,1);
r_power_coop_notech_nopowertrans2025(m21to40,:) = r_power_coop_notech_nopowertrans;
power_coop_notech_nopowertrans2025(m21to40,:) = power_coop;
power_mineral2025 = power_mineral;
Inv_pvwind_mineral2025 = Inv_pvwind_mineral;
save('H:\Global PV and wind\ANS\power_coop_notech_nopowertrans2025_2040CaseB.mat','power_coop_notech_nopowertrans2025','-v7.3')  % TWh/year
save('H:\Global PV and wind\ANS\r_power_coop_notech_nopowertrans_2025_2040CaseB.mat','r_power_coop_notech_nopowertrans2025','-v7.3')  % TWh/year
save('H:\Global PV and wind\ANS\power_mineral_2025_2040CaseB.mat','power_mineral2025','-v7.3')  % TWh/year
save('H:\Global PV and wind\ANS\Inv_pvwind_mineral_2025_2040CaseB.mat','Inv_pvwind_mineral2025','-v7.3')  %
