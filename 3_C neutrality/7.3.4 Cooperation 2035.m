...
save('H:\Global PV and wind\ANS\EF_2035_2040.mat','EF','-v7.3')  % t CO2/kWh
save('H:\Global PV and wind\ANS\unitmin_2035_2040.mat','unitmin','-v7.3')  % t CO2/kWh
...
phhall_all2 = sum(Ph_PVwind5_ef_cou_p(:,:,3),2);
...
r_mineral_pv = [r_mineral_20sa(:,1),r_mineral_20sb(:,1),r_mineral_30sa(:,1)];
r_mineral_wind = [r_mineral_20sa(:,2),r_mineral_20sb(:,2),r_mineral_30sa(:,2)];
...
save('H:\Global PV and wind\ANS\inv_total_cou_PW_noconn_2035_2040.mat','inv_total_cou','-v7.3')  % TWh/year
save('H:\Global PV and wind\ANS\inv_cou_PW_noconn_2035_2040.mat','inv_cou','-v7.3')  % TWh/year
nn_c = nn_c+1;
...
save('H:\Global PV and wind\ANS\r_power_coop_notech_nopower_nomineraltrans2035_2040.mat','r_power_coop_notech_nopower_nomineraltrans2030','-v7.3')  % TWh/year
...
r_power_coop_notech_nopowertrans2030 = zeros(numpowerunit_all,nn_c-1);
r_power_coop_notech_nopowertrans2030(m21to40,:) = r_power_coop_notech_nopowertrans;
power_mineral2030 = power_mineral;
Inv_pvwind_mineral2030 = Inv_pvwind_mineral;
Inv_pvwind_mineral_total(nn_c:end)=[];
Inv_pvwind_mineral2030_total = Inv_pvwind_mineral_total;
save('H:\Global PV and wind\ANS\r_power_coop_notech_nopowertrans_2035_2040.mat','r_power_coop_notech_nopowertrans2030','-v7.3')  % TWh/year
save('H:\Global PV and wind\ANS\power_mineral_2035_2040.mat','power_mineral2030','-v7.3')  % TWh/year
save('H:\Global PV and wind\ANS\Inv_pvwind_mineral_2035_2040.mat','Inv_pvwind_mineral2030','-v7.3')  %
save('H:\Global PV and wind\ANS\Inv_pvwind_mineral_2035_2040_total.mat','Inv_pvwind_mineral2030_total','-v7.3')  %

r_power_coop_notech(:,nn_c:end)=[];
Inv_pvwind_mineral_powertrans(nn_c:end)=[];
power_mineral_powertrans(nn_c:end)=[];
r_power_coop_notech2030 = zeros(numpowerunit_all,nn_c-1);
r_power_coop_notech2030(m21to40,:) = r_power_coop_notech;
power_mineral_powertrans2030 = power_mineral_powertrans;
Inv_pvwind_mineral_powertrans2030 = Inv_pvwind_mineral_powertrans;
Inv_pvwind_mineral_powertrans_total(nn_c:end)=[];
Inv_pvwind_mineral_powertrans2030_total = Inv_pvwind_mineral_powertrans_total;
save('H:\Global PV and wind\ANS\r_power_coop_notech_2035_2040.mat','r_power_coop_notech2030','-v7.3')  % TWh/year
save('H:\Global PV and wind\ANS\power_mineral_powertrans_2035_2040.mat','power_mineral_powertrans2030','-v7.3')  % TWh/year
save('H:\Global PV and wind\ANS\Inv_pvwind_mineral_powertrans_2035_2040.mat','Inv_pvwind_mineral_powertrans2030','-v7.3')  %
save('H:\Global PV and wind\ANS\Inv_pvwind_mineral_powertrans_2035_2040_total.mat','Inv_pvwind_mineral_powertrans2030_total','-v7.3')  %

[B,IX2] = sort(power_mineral_powertrans(2:nn_c-1),'descend');
index_ij_IX = index_ij(IX2+1,1:2);
save('H:\Global PV and wind\ANS\index_ij_2035.mat','index_ij')  % TWh/year
save('H:\Global PV and wind\ANS\index_ij_IX_2035.mat','index_ij_IX')  % 
...
load('H:\Global PV and wind\ANS\Inn_2035.mat')
Inn_2055_2040_ixx = flip(Inn_2035(:,1:2));
Inn_2055_2040_num = Inn_2035(:,3:size(Inn_2035,2));
...
save('H:\Global PV and wind\ANS\index_ij_IX_2035xz.mat','index_ij_IX')  %
...
save('H:\Global PV and wind\ANS\power_mineral_powertrans_tech_cou2035_2040.mat','power_mineral_powertrans_tech_cou','-v7.3')  % TWh/year
...
save('H:\Global PV and wind\ANS\r_power_coop_2035.mat','r_power_coop2030','-v7.3')  % TWh/year
save('H:\Global PV and wind\ANS\power_mineral_powertrans_tech_2035.mat','power_mineral_powertrans_tech2030','-v7.3')  % TWh/year
save('H:\Global PV and wind\ANS\Inv_pvwind_mineral_powertrans_tech_2035.mat','Inv_pvwind_mineral_powertrans_tech2030','-v7.3')  %
