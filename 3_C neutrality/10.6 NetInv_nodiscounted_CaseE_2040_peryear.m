...
load('H:\Global PV and wind\ANS\Inv_PWtoCCS_dis2a_7_2040.mat')  %Inv_PWall_dis2a
...
sum(NetInv)
save('H:\Global PV and wind\ANS\NetInv_nodiscounted_7_2040peryear.mat','NetInv'); % trillion discounted net cost, trillion 2020$
