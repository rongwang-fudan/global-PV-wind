...
save('H:\Global PV and wind\ANS\Owncountry_ID_type_pro_2040s_8a.mat', 'Owncountry_ID2', '-v7.3')
% mineral from own country is 0
save('H:\Global PV and wind\ANS\mineral_reserve2021_others_2040s_8a.mat', 'mineral_reserve2021', '-v7.3')  %  thousand metric tons
save('H:\Global PV and wind\ANS\mineral_production2021_others_2040s_8a.mat', 'mineral_production2021', '-v7.3')  %  thousand metric tons/year
...
save('H:\Global PV and wind\ANS\mineral_plant_2040s_8a.mat', 'mineral_plant', '-v7.3')
...
save('H:\Global PV and wind\ANS\mineral_limit_dis_2040s_8a.mat', 'mineral_limit', '-v7.3')
...
save('H:\Global PV and wind\ANS\mineral_trans8_2040s_8a.mat', 'mineral_trans8', '-v7.3')
% ton，各国之间原材料运输
% 9列 为各类矿物：1 Copper, 2 Zinc, 3 Nickel, 4 Silicon,
% 5 Manganese, 6 Chromium, 7 Molybdenum, 8 Rare earths, 9 Others
save('H:\Global PV and wind\ANS\mineral_trans_plant1_2040s_8a.mat', 'mineral_trans_plant1', '-v7.3')
save('H:\Global PV and wind\ANS\mineral_trans_plant2_2040s_8a.mat', 'mineral_trans_plant2', '-v7.3')
save('H:\Global PV and wind\ANS\mineral_trans_plant3_2040s_8a.mat', 'mineral_trans_plant3', '-v7.3')
save('H:\Global PV and wind\ANS\mineral_trans_plant4_2040s_8a.mat', 'mineral_trans_plant4', '-v7.3')
save('H:\Global PV and wind\ANS\mineral_trans_plant5_2040s_8a.mat', 'mineral_trans_plant5', '-v7.3')
save('H:\Global PV and wind\ANS\mineral_trans_plant6_2040s_8a.mat', 'mineral_trans_plant6', '-v7.3')
save('H:\Global PV and wind\ANS\mineral_trans_plant8_2040s_8a.mat', 'mineral_trans_plant8', '-v7.3')
% ton，各国之间原材料运输
...
save('H:\Global PV and wind\ANS\mineral_trans_reg11_8_2040s_8a.mat', 'mineral_trans_reg11_8', '-v7.3')
save('H:\Global PV and wind\ANS\mineral_trans_reg5_8_2040s_8a.mat', 'mineral_trans_reg5_8', '-v7.3')
...
save('H:\Global PV and wind\ANS\mineral_trans_reg5_8_2040s_8_noselfa.mat', 'mineral_trans_reg5_8_noself', '-v7.3')
