...
%%
load('H:\Global PV and wind\Data\Powerdmeand_country_coal.mat'); % TWh
load('H:\Global PV and wind\Data\Powerdmeand_country_gas.mat'); % TWh
load('H:\Global PV and wind\Data\Powerdmeand_country_oil.mat'); % TWh
...
clear EF_oil
EF_mean = sum(rr.*EF,2);
load('H:\Global PV and wind\Data\Price_coal.mat'); % USD/kWh, 1. mean; 2. std
load('H:\Global PV and wind\Data\Price_gas.mat'); % USD/kWh, 1. mean; 2. std
load('H:\Global PV and wind\Data\Price_oil.mat'); % USD/kWh, 1. mean; 2. std
...
load('H:\Global PV and wind\ANS\B_UHV_STO_INT_county_all_withUHVcost_pro2_8_2040_2s_2020s_test6xz.mat')  
B_utilize_trans_storage5(:,1) = B_utilize_trans_storage; 
B_utilize_trans_storage5(:,2) = B_utilize_trans_storage; 
B_utilize_trans_storage5(:,3) = B_utilize_trans_storage; 
B_utilize_trans_storage5(:,4) = B_utilize_trans_storage; 
load('H:\Global PV and wind\ANS\B_UHV_STO_INT_county_all_withUHVcost_pro2_8_2040_2s_2045_test6xz.mat')  
B_utilize_trans_storage5(:,5) = B_utilize_trans_storage; 
load('H:\Global PV and wind\ANS\B_UHV_STO_INT_county_all_withUHVcost_pro2_8_2040_2s_2050_test6xz.mat') 
B_utilize_trans_storage5(:,6) = B_utilize_trans_storage; 
load('H:\Global PV and wind\ANS\B_UHV_STO_INT_county_all_withUHVcost_pro2_8_2040_2s_2055_test6xz.mat')  
B_utilize_trans_storage5(:,7) = B_utilize_trans_storage; 
load('H:\Global PV and wind\ANS\B_UHV_STO_INT_county_all_withUHVcost_pro2_8_2040_2s_2060_test6xz.mat')  
B_utilize_trans_storage5(:,8) = B_utilize_trans_storage; 
load('H:\Global PV and wind\ANS\B_UHV_STO_INT_county_all_withUHVcost_pro2_8_2040_2s_2065_test6xz.mat')  
B_utilize_trans_storage5(:,9) = B_utilize_trans_storage; 
load('H:\Global PV and wind\ANS\B_UHV_STO_INT_county_all_withUHVcost_pro2_8_2040_2s_2070_test6xz.mat') 
B_utilize_trans_storage5(:,10) = B_utilize_trans_storage; 
load('H:\Global PV and wind\ANS\unitmin2040_8_2sxz.mat');
load('H:\Global PV and wind\ANS\etrans_cou1_num_1023_pro2_8_2040.mat')
etrans_t = sum(sum(etrans_cou1_num,3),2);
load('H:\Global PV and wind\ANS\powerunit_country_IX_IX_8_2040_2s_2070_test6xz.mat'); 

load('H:\Global PV and wind\ANS\EP_8_2040_2s_2070_test6xz.mat')
load('H:\Global PV and wind\ANS\emissionfactor_8_2040_2s_2070_test6xz.mat')
...
EP5(:,10) = EP ; %
load('H:\Global PV and wind\ANS\EP_8_2040_2s_2065_test6xz.mat')  % EP，USD/kWh
load('H:\Global PV and wind\ANS\emissionfactor_8_2040_2s_2065_test6xz.mat')
load('H:\Global PV and wind\ANS\phhall_all2_8_2040_2s_2065_test6xz.mat')
CO2_year_utilize_trans_storage(:,9) = -phhall_all2.*emissionfactor ; % Mt CO2/y
EF5(:,9) = emissionfactor ; %
EP5(:,9) = EP ; %
load('H:\Global PV and wind\ANS\EP_8_2040_2s_2060_test6xz.mat')  % EP，USD/kWh
load('H:\Global PV and wind\ANS\emissionfactor_8_2040_2s_2060_test6xz.mat')
load('H:\Global PV and wind\ANS\phhall_all2_8_2040_2s_2060_test6xz.mat')
CO2_year_utilize_trans_storage(:,8) = -phhall_all2.*emissionfactor ; % Mt CO2/y
EF5(:,8) = emissionfactor ; %
EP5(:,8) = EP ; %
load('H:\Global PV and wind\ANS\EP_8_2040_2s_2055_test6xz.mat')  % EP，USD/kWh
load('H:\Global PV and wind\ANS\emissionfactor_8_2040_2s_2055_test6xz.mat')
load('H:\Global PV and wind\ANS\phhall_all2_8_2040_2s_2055_test6xz.mat')
CO2_year_utilize_trans_storage(:,7) = -phhall_all2.*emissionfactor ; % Mt CO2/y
EF5(:,7) = emissionfactor ; %
EP5(:,7) = EP ; %
load('H:\Global PV and wind\ANS\EP_8_2040_2s_2050_test6xz.mat')  % EP，USD/kWh
load('H:\Global PV and wind\ANS\emissionfactor_8_2040_2s_2050_test6xz.mat')
load('H:\Global PV and wind\ANS\phhall_all2_8_2040_2s_2050_test6xz.mat')
CO2_year_utilize_trans_storage(:,6) = -phhall_all2.*emissionfactor ; % Mt CO2/y
EF5(:,6) = emissionfactor ; %
EP5(:,6) = EP ; %
load('H:\Global PV and wind\ANS\EP_8_2040_2s_2045_test6xz.mat')  % EP，USD/kWh
load('H:\Global PV and wind\ANS\emissionfactor_8_2040_2s_2045_test6xz.mat')
load('H:\Global PV and wind\ANS\phhall_all2_8_2040_2s_2045_test6xz.mat')
...
load('H:\Global PV and wind\ANS\emissionfactor_8_2040_2s_2020s_test6xz.mat')
...
save('H:\Global PV and wind\ANS\unitmin_IX70_2040_8_2s_6_2a_all.mat','unitmin_IX70','-v7.3')  
...
load('H:\Global PV and wind\Data\Ph_country2070_IIASA_2deg_max.mat');
...
% other renewable
load('H:\Global PV and wind\Data\P2070_others_xz.mat')  % P2070_others
% 1.Biomass; 2.Geothermal; 3.Hydro; 4.Nuclear; 5.Ocean;
IXX = [3,2,4,1,5];
P2070_others = P2070_others(:,IXX);
P_cum = (cumsum(P2070_others'))';
others(:,1) = min(sum(P2070_others,2),Ph_country2070_IIASA_2deg);
% power genration of other renewable without PV and wind
...
for i = 1:1:size(B_utilize_trans_storage_IX70,1)
    ...
    if isempty(cou_all)
        ...
        p_others2070(i+1,10) = sum(sum(others(:,i+1)));
        Inv_others2070(i+1,10) = sum(Inv_others2070_c(:,i+1)); 
...
for i = 1:1:size(B_utilize_trans_storage_IX70,1)+1
    if i ==1
        Inv_IX2 = 0;
        Inv_noe_IX2 = 0;
        Inv_CCS2070(i,10) = 0; % million USD
        ...
        Inv_CCS2070(i,10) = sum(130.85*Aba_CCS*1000)+pccs(i).*EP5_IX70(i-1,10)*10^3; % million USD
...
load('H:\Global PV and wind\Data\Ph_country2070_IIASA_2deg_max.mat');
load('H:\Global PV and wind\Data\Ph_country2060_IIASA_2deg_max.mat');
...
clear Inv_others2070_c
% other renewable
load('H:\Global PV and wind\Data\P2060_others_xz.mat')  % P2060_others
% 1.Biomass; 2.Geothermal; 3.Hydro; 4.Nuclear; 5.Ocean;
load('H:\Global PV and wind\Data\P2070_others_xz.mat')  % P2060_others
...
for i = 1:1:size(B_utilize_trans_storage_IX70,1)+1
    if i ==1
        ...
        Inv_CCS2070(i,9) = sum(130.85*Aba_CCS*1000)+pccs(i).*EP5_IX70(i-1,9)*10^3; % million USD
...
load('H:\Global PV and wind\Data\Ph_country2060_IIASA_2deg_max.mat');
load('H:\Global PV and wind\Data\Ph_country2050_IIASA_2deg_max.mat');
...
clear Inv_others2070_c
% other renewable
load('H:\Global PV and wind\Data\P2050_others_xz.mat')  % P2050_others
load('H:\Global PV and wind\Data\P2060_others_xz.mat')  % P2050_others
% 1.Biomass; 2.Geothermal; 3.Hydro; 4.Nuclear; 5.Ocean;
...
for i = 1:1:size(B_utilize_trans_storage_IX70,1)+1
    if i ==1
        ...
        Inv_CCS2070(i,7) = sum(130.85*Aba_CCS*1000)+pccs(i).*EP5_IX70(i-1,7)*10^3; % million USD
...
load('H:\Global PV and wind\Data\Ph_country2050_IIASA_2deg_max.mat');
load('H:\Global PV and wind\Data\Ph_country2040_IIASA_2deg_max.mat');
...
clear Inv_others2070_c
% other renewable
load('H:\Global PV and wind\Data\P2050_others_xz.mat')  % P2040_others
load('H:\Global PV and wind\Data\P2040_others_xz.mat')  % P2040_others
% 1.Biomass; 2.Geothermal; 3.Hydro; 4.Nuclear; 5.Ocean;
...
for i = 1:1:size(B_utilize_trans_storage_IX70,1)+1
    if i ==1
        ...
        Inv_CCS2070(i,5) = sum(130.85*Aba_CCS*1000)+pccs(i).*EP5_IX70(i-1,5)*10^3; % million USD
...
save('H:\Global PV and wind\ANS\lrr_CCS2040_8_2s_6_2a.mat','lrr_CCS','-v7.3')  % million $
...
Inv_CCS2070_c_cou0(:,1:4) = repmat(Inv_CCS2070_2(1,1:4),192,1).*repmat(rrc,1,4); % 
...
Inv_CCS2070_c_cou0(:,5) = repmat(Inv_CCS2070_2(1,5),192,1).*repmat(rrc5,1,1); % 
Inv_CCS2070_c_cou0(:,6) = repmat(Inv_CCS2070_2(1,6),192,1).*repmat(rrc6,1,1); % 
Inv_CCS2070_c_cou0(:,7) = repmat(Inv_CCS2070_2(1,7),192,1).*repmat(rrc7,1,1); %
Inv_CCS2070_c_cou0(:,8) = repmat(Inv_CCS2070_2(1,8),192,1).*repmat(rrc8,1,1); %
Inv_CCS2070_c_cou0(:,9) = repmat(Inv_CCS2070_2(1,9),192,1).*repmat(rrc9,1,1); %
Inv_CCS2070_c_cou0(:,10) = repmat(Inv_CCS2070_2(1,10),192,1).*repmat(rrc10,1,1); %
save('H:\Global PV and wind\ANS\Inv_CCS2040_c_cou0_8_2s_6_2a.mat','Inv_CCS2070_c_cou0','-v7.3')  % million $
...
rrc = a(:,1)./sum(a(:,1));
Inv_others2070_c_cou0(:,1:4) = repmat(Inv_others_c(1,1:4),192,1).*repmat(rrc,1,4); %
Inv_others2070_cou0(:,1:4) = repmat(Inv_others(1,1:4),192,1).*repmat(rrc,1,4); %
...
rrc3(:,10) = a(:,1)./sum(a(:,1));
for i = 5:1:10
Inv_others2070_c_cou0(:,i) = repmat(Inv_others_c(1,i),192,1).*repmat(rrc3(:,i),1,1); 
Inv_others2070_cou0(:,i) = repmat(Inv_others(1,i),192,1).*repmat(rrc3(:,i),1,1); 
end
sum(Inv_others2070_c_cou0)-Inv_others_c(1,:)
save('H:\Global PV and wind\ANS\Inv_others2040_c_cou0_8_2s_6_2a.mat','Inv_others2070_c_cou0','-v7.3')  % million $
save('H:\Global PV and wind\ANS\Inv_others2040_cou0_8_2s_6_2a.mat','Inv_others2070_cou0','-v7.3')  % million $

Ph_others5 = p_others2070_2;
save('H:\Global PV and wind\ANS\Inv_others_e2040_8_2s_6_2a.mat','Inv_others_e','-v7.3')  % million $
save('H:\Global PV and wind\ANS\Inv_others2040_8_2s_6_2a.mat','Inv_others','-v7.3')  % million $
save('H:\Global PV and wind\ANS\Ph_others2040_8_2s_6_2a.mat','Ph_others5','-v7.3')  % TWh/yr
save('H:\Global PV and wind\ANS\Inv_CCS2040_8_2s_6_2a.mat','Inv_CCS2070','-v7.3')  % million $
save('H:\Global PV and wind\ANS\Ph_CCS2040_8_2s_6_2a.mat','Ph_CCS5','-v7.3')  % TWh/yr

Inv_CCS2070_c = Inv_CCS2070_2;
Inv_CCS2070_e(:,1:4) = repmat(Inv_CCS2070_e(:,4),1,4).*(Ph_CCS5_2(:,1:4)./repmat(Ph_CCS5_2(:,4),1,4))
save('H:\Global PV and wind\ANS\Inv_CCS2040_c_8_2s_6_2a.mat','Inv_CCS2070_c','-v7.3')  % million $
save('H:\Global PV and wind\ANS\Inv_CCS2040_e_8_2s_6_2a.mat','Inv_CCS2070_e','-v7.3')  % million $
...
load('H:\Global PV and wind\Data\Ph_country2030_IIASA_2deg_max.mat'); 
load('H:\Global PV and wind\Data\Ph_country2040_IIASA_2deg_max.mat'); 
...
load('H:\Global PV and wind\Data\Ph_country2025_IIASA_2deg_max.mat');
...
save('H:\Global PV and wind\ANS\Inv_PVwind2040_noe_8_2s_6_2a.mat','Inv_PVwind2070_noe','-v7.3')  % million $
save('H:\Global PV and wind\ANS\Inv_PVwind2040_8_2s_6_2a.mat','Inv_PVwind2070','-v7.3')  % million $
save('H:\Global PV and wind\ANS\Inv_CCSPVWind2040_8_2s_6_2a.mat','Inv_CCSPVWind','-v7.3')  % trillion $
save('H:\Global PV and wind\ANS\Inv_clean2040_8_2s_6_2a.mat','Inv_clean','-v7.3')  % trillion $
save('H:\Global PV and wind\ANS\Ph_PVwind2040_8_2s_6_2a.mat','Ph_PVwind5','-v7.3')  % TWh/yr
save('H:\Global PV and wind\ANS\unitmin_IX70_2040_8_2s_6_2a.mat','unitmin_IX70','-v7.3')  % TWh/yr
save('H:\Global PV and wind\ANS\Ph_PVwind5_ef_cou_2040_8_2s_6_2a.mat','Ph_PVwind5_ef_cou','-v7.3')  % TWh/yr
save('H:\Global PV and wind\ANS\Ph_PVwind5_ef_cou_p_2040_8_2s_6_2a.mat','Ph_PVwind5_ef_cou_p','-v7.3')  % TWh/yr
