...
%% 筛选出2040年电厂
load('H:\Global PV and wind\ANS\powerunit_country_IX_IX_8_2040_2s_2045_test6xz_CaseB.mat'); % powerunit_country_IX_IX
...
load('H:\Global PV and wind\ANS\B_UHV_STO_INT_county_all_withUHVcost_pro2_8_2040_2s_2045_test6xz_CaseB.mat')  % B_utilize_trans_storage
...
load('H:\Global PV and wind\ANS\EP_8_2040_2s_2045_test6xz_CaseB.mat')  % EP，USD/kWh
load('H:\Global PV and wind\ANS\CO2_year_utilize_trans_storage_8_2040_2s_2045_test6xz_CaseB.mat')  % CO2_year_utilize_trans_storage, Mt CO2/year
load('H:\Global PV and wind\ANS\phhall_all2_8_2040_2s_2045_test6xz_CaseB.mat')
load('H:\Global PV and wind\ANS\unitmin2040_8_2sxz.mat'); %%
load('H:\Global PV and wind\ANS\Plant_ID_IX_2040_8.mat')
load('H:\Global PV and wind\ANS\optpowerunit_IX_8_2040_2s_2045_test6xz_CaseB.mat'); % optpowerunit_IX
% Plant_ID_IX
% 但这个不是按照原始LCOE排序的
...
save('H:\Global PV and wind\ANS\inv_total_cou_PW_noconn_2045_2040CaseB.mat','inv_total_cou','-v7.3')  % million $,total cost
save('H:\Global PV and wind\ANS\inv_cou_PW_noconn_2045_2040CaseB.mat','inv_cou','-v7.3')  % TWh/year
nn_c = nn_c+1;

r_power_coop_notech_nopowertrans = r_power_coop;
Inv_pvwind_mineral(1,1) = inv;% million USD

r_power_coop_notech_nopowertrans2045 = zeros(numpowerunit_all,1);
power_coop_notech_nopowertrans2045 = zeros(numpowerunit_all,1);
r_power_coop_notech_nopowertrans2045(m21to40,:) = r_power_coop_notech_nopowertrans;
power_coop_notech_nopowertrans2045(m21to40,:) = power_coop;
power_mineral2045 = power_mineral;
Inv_pvwind_mineral2045 = Inv_pvwind_mineral;
save('H:\Global PV and wind\ANS\power_coop_notech_nopowertrans2045_2040CaseB.mat','power_coop_notech_nopowertrans2045','-v7.3')  % TWh/year
save('H:\Global PV and wind\ANS\r_power_coop_notech_nopowertrans_2045_2040CaseB.mat','r_power_coop_notech_nopowertrans2045','-v7.3')  % TWh/year
save('H:\Global PV and wind\ANS\power_mineral_2045_2040CaseB.mat','power_mineral2045','-v7.3')  % TWh/year
save('H:\Global PV and wind\ANS\Inv_pvwind_mineral_2045_2040CaseB.mat','Inv_pvwind_mineral2045','-v7.3')  %
