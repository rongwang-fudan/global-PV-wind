...
%% 筛选出2040年电厂
load('H:\Global PV and wind\ANS\powerunit_country_IX_IX_8_2040_2s_2045_test6xz.mat'); % powerunit_country_IX_IX
load('H:\Global PV and wind\ANS\B_UHV_STO_INT_county_all_withUHVcost_pro2_7_2040_2s_2045_test6.mat')  % B_utilize_trans_storage
B_utilize_trans_storage_nodiffuse = B_utilize_trans_storage;
load('H:\Global PV and wind\ANS\B_UHV_STO_INT_county_all_withUHVcost_pro2_8_2040_2s_2045_test6xz.mat')  % B_utilize_trans_storage
load('H:\Global PV and wind\ANS\B_UHV_STO_INT_county_all_withUHVcost_pro2_192countrya_2040_8_2045.mat')  % B_utilize_trans_storage_192
% num*192,用各国的学习率计算出来的MAC
load('H:\Global PV and wind\ANS\EP_8_2040_2s_2045_test6xz.mat')  % EP，USD/kWh
load('H:\Global PV and wind\ANS\CO2_year_utilize_trans_storage_8_2040_2s_2045_test6xz.mat')  % CO2_year_utilize_trans_storage, Mt CO2/year
...
load('H:\Global PV and wind\ANS\optpowerunit_IX_8_2040_2s_2045_test6xz.mat'); % optpowerunit_IX
% Plant_ID_IX
% 但这个不是按照原始LCOE排序的
...
save('H:\Global PV and wind\ANS\EF_2045_2040.mat','EF','-v7.3')  % t CO2/kWh
save('H:\Global PV and wind\ANS\unitmin_2045_2040.mat','unitmin','-v7.3')  % t CO2/kWh
...
Ph_PVwind5_ef_cou_p2040 = Ph_PVwind5_ef_cou_p(:,:,5);
r = sum(Ph_PVwind5_ef_cou_p2040,2)./phhall_all2;
phhall_all2 = sum(Ph_PVwind5_ef_cou_p(:,:,5),2);
...
r_mineral_pv = [r_mineral_20sa(:,1),r_mineral_20sb(:,1),r_mineral_30sa(:,1),r_mineral_30sb(:,1),r_mineral_40sa(:,1)];
r_mineral_wind = [r_mineral_20sa(:,2),r_mineral_20sb(:,2),r_mineral_30sa(:,2),r_mineral_30sb(:,2),r_mineral_40sa(:,2)];
...
save('H:\Global PV and wind\ANS\power_mineral_cou2045_2040.mat','power_mineral_cou','-v7.3')  % TWh/year
save('H:\Global PV and wind\ANS\inv_total_cou_PW_noconn_2045_2040.mat','inv_total_cou','-v7.3')  % TWh/year
save('H:\Global PV and wind\ANS\inv_cou_PW_noconn_2045_2040.mat','inv_cou','-v7.3')  % TWh/year
save('H:\Global PV and wind\ANS\asw_2045_2040.mat','asw','-v7.3')  % million $
nn_c = nn_c+1;
...
save('H:\Global PV and wind\ANS\r_power_coop_notech_nopower_nomineraltrans2045.mat','r_power_coop_notech_nopower_nomineraltrans2040','-v7.3')  % TWh/year
...
save('H:\Global PV and wind\ANS\power_mineraltrans_cou2045_2040.mat','power_mineral_cou','-v7.3')  % TWh/year
save('H:\Global PV and wind\ANS\power_mineral_powertrans_cou2045_2040.mat','power_mineral_powertrans_cou','-v7.3')  % TWh/year
...
save('H:\Global PV and wind\ANS\r_power_coop_notech_nopowertrans_2045.mat','r_power_coop_notech_nopowertrans2040','-v7.3')  % TWh/year
save('H:\Global PV and wind\ANS\power_mineral_2045.mat','power_mineral2040','-v7.3')  % TWh/year
save('H:\Global PV and wind\ANS\Inv_pvwind_mineral_2045.mat','Inv_pvwind_mineral2040','-v7.3')  %
save('H:\Global PV and wind\ANS\Inv_pvwind_mineral_2045_total.mat','Inv_pvwind_mineral2040_total','-v7.3')  %
...
save('H:\Global PV and wind\ANS\r_power_coop_notech_2045.mat','r_power_coop_notech2040','-v7.3')  % TWh/year
save('H:\Global PV and wind\ANS\power_mineral_powertrans_2045.mat','power_mineral_powertrans2040','-v7.3')  % TWh/year
save('H:\Global PV and wind\ANS\Inv_pvwind_mineral_powertrans_2045.mat','Inv_pvwind_mineral_powertrans2040','-v7.3')  %
save('H:\Global PV and wind\ANS\Inv_pvwind_mineral_powertrans_2045_total.mat','Inv_pvwind_mineral_powertrans2040_total','-v7.3')  %

[B,IX2] = sort(power_mineral_powertrans(2:nn_c-1),'descend');
index_ij_IX = index_ij(IX2+1,1:2);
save('H:\Global PV and wind\ANS\index_ij_2045.mat','index_ij')  % TWh/year
save('H:\Global PV and wind\ANS\index_ij_IX_2045.mat','index_ij_IX')  %
...
load('H:\Global PV and wind\ANS\Inn_2045.mat')
Inn_2055_2040_ixx = flip(Inn_2045(:,1:2));
Inn_2055_2040_num = Inn_2045(:,3:size(Inn_2045,2));
...
save('H:\Global PV and wind\ANS\index_ij_IX_2045xz.mat','index_ij_IX')  %
...
save('H:\Global PV and wind\ANS\power_mineral_powertrans_tech_cou2045_2040.mat','power_mineral_powertrans_tech_cou','-v7.3')  % TWh/year
...
save('H:\Global PV and wind\ANS\r_power_coop_2045.mat','r_power_coop2040','-v7.3')  % TWh/year
save('H:\Global PV and wind\ANS\power_mineral_powertrans_tech_2045.mat','power_mineral_powertrans_tech2040','-v7.3')  % TWh/year
save('H:\Global PV and wind\ANS\Inv_pvwind_mineral_powertrans_tech_2045.mat','Inv_pvwind_mineral_powertrans_tech2040','-v7.3')  %
