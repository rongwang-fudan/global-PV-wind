...
MAC_CCS = 130.85;
save('H:\Global PV and wind\ANS\B_utilize_trans_storage_nodiffuse_2070_2040baseline.mat','B_utilize_trans_storage_nodiffuse','-v7.3')  % TWh/year
save('H:\Global PV and wind\ANS\CO2_year_utilize_trans_storage_2070_2040baseline.mat','CO2_year_utilize_trans_storage','-v7.3')  % TWh/year
save('H:\Global PV and wind\ANS\phhall_all2_2070_2040baseline.mat','phhall_all2','-v7.3')  % TWh/year
...
save('H:\Global PV and wind\ANS\inv_total_cou_PW_noconn_2070_2040baseline.mat','inv_total_cou','-v7.3')  % million $,total cost
save('H:\Global PV and wind\ANS\inv_cou_PW_noconn_2070_2040baseline.mat','inv_cou','-v7.3')  % TWh/year
nn_c = nn_c+1;
...
save('H:\Global PV and wind\ANS\power_coop_notech_nopowertrans2070_2040baseline.mat','power_coop_notech_nopowertrans2070','-v7.3')  % TWh/year
save('H:\Global PV and wind\ANS\r_power_coop_notech_nopowertrans_2070_2040baseline.mat','r_power_coop_notech_nopowertrans2070','-v7.3')  % TWh/year
save('H:\Global PV and wind\ANS\power_mineral_2070_2040baseline.mat','power_mineral2070','-v7.3')  % TWh/year
save('H:\Global PV and wind\ANS\Inv_pvwind_mineral_2070_2040baseline.mat','Inv_pvwind_mineral2070','-v7.3')  %
