...
p_surplus = Ph_PW(:,1).*sum(r_power_coop2025xz,2)-Ph_PW(:,1).*r_power_coop2025xz(:,1);
...
load('H:\Global PV and wind\ANS\inv_total_cou_PW_noconn_2025_2040.mat')  % inv_cou
Inv_pvwind2025_total = inv_total_cou;
load('H:\Global PV and wind\ANS\inv_cou_PW_noconn_2025_2040.mat')  % inv_cou
...
p_surplus = Ph_PW(:,2).*sum(r_power_coop2030xz,2)-Ph_PW(:,2).*r_power_coop2030xz(:,1);
p_surplus(p_surplus<0)=0;
...
load('H:\Global PV and wind\ANS\inv_total_cou_PW_noconn_2030_2040.mat')  % inv_cou
...
p_surplus = Ph_PW(:,3).*sum(r_power_coop2035xz,2)-Ph_PW(:,3).*r_power_coop2035xz(:,1);
p_surplus(p_surplus<0)=0;
...
load('H:\Global PV and wind\ANS\inv_total_cou_PW_noconn_2035_2040.mat')  % inv_cou
...
p_surplus = Ph_PW(:,4).*sum(r_power_coop2040xz,2)-Ph_PW(:,4).*r_power_coop2040xz(:,1);
p_surplus(p_surplus<0)=0;
Inv_PWtoCCS2030a = p_surplus.*(-EF).*MAC_CCS_p;
Inv_PWtoCCS2040 = zeros(192,1);
for i = 1:192
    [m,n]=find(powerunit_country_IX_IX==i);
    Inv_PWtoCCS2040(i) = sum(Inv_PWtoCCS2030a(m));
end
clear Inv_PWtoCCS2030a
load('H:\Global PV and wind\ANS\inv_total_cou_PW_noconn_2040_2040.mat')  % inv_cou
...
p_surplus = Ph_PW(:,5).*sum(r_power_coop2045xz,2)-Ph_PW(:,5).*r_power_coop2045xz(:,1);
p_surplus(p_surplus<0)=0;
...
load('H:\Global PV and wind\ANS\inv_total_cou_PW_noconn_2045_2040.mat')  % inv_cou
...
p_surplus = Ph_PW(:,6).*sum(r_power_coop2050xz,2)-Ph_PW(:,6).*r_power_coop2050xz(:,1);
p_surplus(p_surplus<0)=0;
Inv_PWtoCCS2030a = p_surplus.*(-EF).*MAC_CCS_p;
Inv_PWtoCCS2050 = zeros(192,1);
for i = 1:192
    [m,n]=find(powerunit_country_IX_IX==i);
    Inv_PWtoCCS2050(i) = sum(Inv_PWtoCCS2030a(m));
end
clear Inv_PWtoCCS2030a
load('H:\Global PV and wind\ANS\inv_total_cou_PW_noconn_2050_2040.mat')  % inv_cou
...
p_surplus = Ph_PW(:,7).*sum(r_power_coop2055xz,2)-Ph_PW(:,7).*r_power_coop2055xz(:,1);
p_surplus(p_surplus<0)=0;
...
load('H:\Global PV and wind\ANS\inv_total_cou_PW_noconn_2055_2040.mat')  % inv_cou
...
p_surplus = Ph_PW(:,8).*sum(r_power_coop2060xz,2)-Ph_PW(:,8).*r_power_coop2060xz(:,1);
p_surplus(p_surplus<0)=0;
Inv_PWtoCCS2030a = p_surplus.*(-EF).*MAC_CCS_p;
Inv_PWtoCCS2060 = zeros(192,1);
for i = 1:192
    [m,n]=find(powerunit_country_IX_IX==i);
    Inv_PWtoCCS2060(i) = sum(Inv_PWtoCCS2030a(m));
end
clear Inv_PWtoCCS2030a
load('H:\Global PV and wind\ANS\inv_total_cou_PW_noconn_2060_2040.mat')  % inv_cou
...
p_surplus = Ph_PW(:,9).*sum(r_power_coop2065xz,2)-Ph_PW(:,9).*r_power_coop2065xz(:,1);
p_surplus(p_surplus<0)=0;
...
load('H:\Global PV and wind\ANS\inv_total_cou_PW_noconn_2065_2040.mat')  % inv_cou
...
p_surplus = Ph_PW(:,10).*sum(r_power_coop2070xz,2)-Ph_PW(:,10).*r_power_coop2070xz(:,1);
p_surplus(p_surplus<0)=0;
Inv_PWtoCCS2030a = p_surplus.*(-EF).*MAC_CCS_p;
Inv_PWtoCCS2070 = zeros(192,1);
for i = 1:192
    [m,n]=find(powerunit_country_IX_IX==i);
    Inv_PWtoCCS2070(i) = sum(Inv_PWtoCCS2030a(m));
end
clear Inv_PWtoCCS2030a
load('H:\Global PV and wind\ANS\inv_total_cou_PW_noconn_2070_2040.mat')  % inv_cou
...
save('H:\Global PV and wind\ANS\Inv_PWall_dis2a_5_2040.mat','Inv_PWall_dis2a','-v7.3')  %
save('H:\Global PV and wind\ANS\Inv_PWall_total_dis2a_5_2040.mat','Inv_PWall_total_dis2a','-v7.3')  %
save('H:\Global PV and wind\ANS\Inv_PWtoCCS_dis2a_5_2040.mat','Inv_PWtoCCS_dis2a','-v7.3')  %
