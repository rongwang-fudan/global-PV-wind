...
%% 筛选出2040年电厂
load('H:\Global PV and wind\ANS\powerunit_country_IX_IX_8_2040_2s_2050_test6xz_CaseA.mat'); % powerunit_country_IX_IX
...
load('H:\Global PV and wind\ANS\B_UHV_STO_INT_county_all_withUHVcost_pro2_8_2040_2s_2050_test6xz_CaseA.mat')  % B_utilize_trans_storage
...
load('H:\Global PV and wind\ANS\EP_8_2040_2s_2050_test6xz_CaseA.mat')  % EP，USD/kWh
load('H:\Global PV and wind\ANS\CO2_year_utilize_trans_storage_8_2040_2s_2050_test6xz_CaseA.mat')  % CO2_year_utilize_trans_storage, Mt CO2/year
load('H:\Global PV and wind\ANS\phhall_all2_8_2040_2s_2050_test6xz_CaseA.mat')
load('H:\Global PV and wind\ANS\unitmin2040_8_2sxz.mat'); %%
load('H:\Global PV and wind\ANS\Plant_ID_IX_2040_8.mat')
load('H:\Global PV and wind\ANS\optpowerunit_IX_8_2040_2s_2050_test6xz_CaseA.mat'); % optpowerunit_IX
% Plant_ID_IX
% 但这个不是按照原始LCOE排序的
...
save('H:\Global PV and wind\ANS\inv_total_cou_PW_noconn_2050_2040CaseA.mat','inv_total_cou','-v7.3')  % million $,total cost
save('H:\Global PV and wind\ANS\inv_cou_PW_noconn_2050_2040CaseA.mat','inv_cou','-v7.3')  % TWh/year
nn_c = nn_c+1;
...
save('H:\Global PV and wind\ANS\power_coop_notech_nopowertrans2050_2040CaseA.mat','power_coop_notech_nopowertrans2050','-v7.3')  % TWh/year
save('H:\Global PV and wind\ANS\r_power_coop_notech_nopowertrans_2050_2040CaseA.mat','r_power_coop_notech_nopowertrans2050','-v7.3')  % TWh/year
save('H:\Global PV and wind\ANS\power_mineral_2050_2040CaseA.mat','power_mineral2050','-v7.3')  % TWh/year
save('H:\Global PV and wind\ANS\Inv_pvwind_mineral_2050_2040CaseA.mat','Inv_pvwind_mineral2050','-v7.3')  %
