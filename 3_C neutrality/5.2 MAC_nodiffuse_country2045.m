...
for countrya = 1:192
    for i = 1:192
        ...
        %         learnprice_region(i,:,:) = learnprice_region2_2(countrya,:,:);
    ...
    countrya
    clearvars -except initialcost_ratio_country_off r_fixednomodule_hardwarecost_ons learnprice_region_nodiffuse B_utilize_trans_storage_192 learnprice_region2_2 initialcost_ratio_country r_module_hardwarecost_pv r_module_hardwarecost_ons
end
save('H:\Global PV and wind\ANS\B_UHV_STO_INT_county_all_withUHVcost_pro2_192countrya_2040_8_2045.mat','B_utilize_trans_storage_192', '-v7.3')  % billion kWh / year
