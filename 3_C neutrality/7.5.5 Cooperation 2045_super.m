...
load('H:\Global PV and wind\ANS\B_UHV_STO_INT_county_all_withUHVcost_pro2_8_2040_2s_2045_test6xzsuper.mat')  % B_utilize_trans_storage
...
save('H:\Global PV and wind\ANS\EF_2045_2040super.mat','EF','-v7.3')  % t CO2/kWh
save('H:\Global PV and wind\ANS\unitmin_2045_2040super.mat','unitmin','-v7.3')  % t CO2/kWh
...
load('H:\Global PV and wind\ANS\Inn_2045_2040super.mat')
...
% 先技术转移，让35达到diffuse的成本
save('H:\Global PV and wind\ANS\index_ij_IX_2045xzsuper.mat','index_ij_IX')  %
...
save('H:\Global PV and wind\ANS\power_mineral_powertrans_tech_cou2045_2040super.mat','power_mineral_powertrans_tech_cou','-v7.3')  % TWh/year
...
save('H:\Global PV and wind\ANS\r_power_coop_2045super.mat','r_power_coop2040','-v7.3')  % TWh/year
save('H:\Global PV and wind\ANS\power_mineral_powertrans_tech_2045super.mat','power_mineral_powertrans_tech2040','-v7.3')  % TWh/year
save('H:\Global PV and wind\ANS\Inv_pvwind_mineral_powertrans_tech_2045super.mat','Inv_pvwind_mineral_powertrans_tech2040','-v7.3')  %
