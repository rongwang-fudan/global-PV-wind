...
gridarea=gridarea120 * 4 *ones(1,360*30);% 1/120*1/30,Km2
clear gridarea120

% ENERGY 1
load('H:\Global PV and wind\Data\SR_12to20_day_max.mat'); % 
load('H:\Global PV and wind\Data\SR_12to20_day.mat'); % 
% GEOGRAPHIC DATA 2
...
% Ground slope (%)
load('H:\Global PV and wind\Data\T_12to20_max.mat'); % 
load('H:\Global PV and wind\Data\T_12to20.mat'); % 
...
for coun = 1:1:34
    ...
    if max(n)-min(n)<4000
        if (~isempty(m))
            ...
            filename = strcat('H:\Global PV and wind\Code\1_PV and wind power plant optimization\PV_power potential\ANS\powerunit_',num2str(coun),'_sameC.mat');
            save(filename, 'powerunit','-v7.3');
            
            filename = strcat('H:\Global PV and wind\Code\1_PV and wind power plant optimization\PV_power potential\ANS\unitid_',num2str(coun),'_sameC.mat');
            save(filename, 'unitid','-v7.3');
            
            filename = strcat('H:\Global PV and wind\Code\1_PV and wind power plant optimization\PV_power potential\ANS\unitid_all_',num2str(coun),'_sameC.mat');
            save(filename, 'unitid_all','-v7.3');
            
            filename = strcat('H:\Global PV and wind\Code\1_PV and wind power plant optimization\PV_power potential\ANS\unitid_cy_',num2str(coun),'_sameC.mat');
...
save('H:\Global PV and wind\Code\1_PV and wind power plant optimization\PV_power potential\ANS\position_county_PV_sameC.dat','position_county');
