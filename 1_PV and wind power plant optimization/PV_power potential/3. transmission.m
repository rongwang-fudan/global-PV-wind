...
clear powerunit_w
% load('H:\world\code\index_mineral_pv_county0811.mat') % 按照成本排序后保留的PV电厂原始序号
% powerunit = powerunit_w(index_mineral_pv,:);
% clear powerunit_w
...
save('H:\global-PV-wind\Code\1_PV and wind power plant optimization\PV_power potential\ANS\tranmission_lines_all.dat','lines');
