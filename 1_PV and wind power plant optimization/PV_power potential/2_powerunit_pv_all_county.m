tic
clear;
load('H:\Global PV and wind\Code\1_PV and wind power plant optimization\PV_power potential\ANS\position_county_PV_sameC.dat','-mat');
...
for iii = 1:max(max(GADM_country120))
    ...
    load(strcat('H:\Global PV and wind\Code\1_PV and wind power plant optimization\PV_power potential\ANS\powerunit_',num2str(coun),'_sameC.mat'));
    load(strcat('H:\Global PV and wind\Code\1_PV and wind power plant optimization\PV_power potential\ANS\unitid_',num2str(coun),'_sameC.mat'));
    load(strcat('H:\Global PV and wind\Code\1_PV and wind power plant optimization\PV_power potential\ANS\unitid_all_',num2str(coun),'_sameC.mat'));
    load(strcat('H:\Global PV and wind\Code\1_PV and wind power plant optimization\PV_power potential\ANS\unitid_cy_',num2str(coun),'_sameC.mat'));
    if (~isempty(powerunit))
    unitid_w11 = zeros(21600,10800);
    unitid_all_w11 = zeros(21600,10800);
    unitid_pro_w11 = zeros(21600,10800);
    if position_county(coun,5)~=2
        ...
        unitid_pro_w11(position_county(coun,1):position_county(coun,2),position_county(coun,3):position_county(coun,4))=unitid_cy;
    end
    ...
    if position_county(coun,5)==2
        ...
        unitid_pro_w11(:,1:5400) = unitid_pro_w111(:,5401:10800);
        unitid_pro_w11(:,5401:10800) = unitid_pro_w111(:,1:5400);
    end
    ...
    [m,n]=find(unitid_pro_w11~=0);
    unitid_cy_w(sub2ind(size(unitid_cy_w), m, n))= unitid_pro_w11(sub2ind(size(unitid_pro_w11), m, n));
...
save('H:\Global PV and wind\Code\1_PV and wind power plant optimization\PV_power potential\ANS\unitid_w_pv_county.dat','unitid_w'); % plant id，real pixel installed PV panles
save('H:\Global PV and wind\Code\1_PV and wind power plant optimization\PV_power potential\ANS\unitid_all_w_pv_county.dat','unitid_all_w'); % plant id，all the pixel within the power plant
save('H:\Global PV and wind\Code\1_PV and wind power plant optimization\PV_power potential\ANS\unitid_cy_w_pv_county.dat','unitid_cy_w'); % cy,
save('H:\Global PV and wind\Code\1_PV and wind power plant optimization\PV_power potential\ANS\powerunit_w_pv_county.dat','powerunit_w');
