...
load('H:\Global PV and wind\Data\Fixedcost_PV_country.mat')  % 2020USD/kW
...
clear powerunit_w
load('H:\Global PV and wind\Code\1_PV and wind power plant optimization\PV_power potential\ANS\costunits01_2_all2.dat','-mat');
...
save('H:\Global PV and wind\Code\1_PV and wind power plant optimization\PV_power potential\ANS\powers_PV_100GW_3_2_all2_5%_inilow.mat','powers','-v7.3'); % USD2019/kWh
save('H:\Global PV and wind\Code\1_PV and wind power plant optimization\PV_power potential\ANS\CPPP111_PV_100GW_3_2_all2_5%_inilow.mat','CPPP111','-v7.3'); % GW
save('H:\Global PV and wind\Code\1_PV and wind power plant optimization\PV_power potential\ANS\unitid_lcoe_100GW_3_2_all2_5%_inilow.dat','unitid_lcoe');
save('H:\Global PV and wind\Code\1_PV and wind power plant optimization\PV_power potential\ANS\unitid_lcoe_all_100GW_3_2_all2_5%_inilow.dat','unitid_lcoe_all');
...
clear powerunit_w
load('H:\Global PV and wind\Code\1_PV and wind power plant optimization\PV_power potential\ANS\tranmission_lines_all.dat','-mat'); % lines
load('H:\Global PV and wind\Code\1_PV and wind power plant optimization\PV_power potential\ANS\powers_PV_100GW_3_2_all2_5%_inilow.mat')
load('H:\Global PV and wind\Code\1_PV and wind power plant optimization\PV_power potential\ANS\CPPP111_PV_100GW_3_2_all2_5%_inilow.mat')
...
save('H:\Global PV and wind\Code\1_PV and wind power plant optimization\PV_power potential\ANS\CPPP111_PV_IX_100GW_3_2_all2_5%_inilow.mat','CPPP111_IX','-v7.3'); % MW
optpowerunit_PV = optpowerunit(:,1:34);
save('H:\Global PV and wind\Code\1_PV and wind power plant optimization\PV_power potential\ANS\optpowerunit_PV_100GW_3_2_all2_5%_inilow.mat','optpowerunit_PV'); % power ID
powerunit_IX_PV = powerunit_IX;
save('H:\Global PV and wind\Code\1_PV and wind power plant optimization\PV_power potential\ANS\powerunit_IX_PV_100GW_3_2_all2_5%_inilow.mat','powerunit_IX_PV'); % power ID
save('H:\Global PV and wind\Code\1_PV and wind power plant optimization\PV_power potential\ANS\tranmission_lines_IX_100GW_3_2_all2_5%_inilow.mat','lines_IX'); %
powerunit_num_IX_PV = powerunit_num_IX;
save('H:\Global PV and wind\Code\1_PV and wind power plant optimization\PV_power potential\ANS\powerunit_num_IX_PV_100GW_3_2_all2_5%_inilow.mat','powerunit_num_IX_PV'); %
