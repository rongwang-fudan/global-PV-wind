...
load('H:\Global PV and wind\Data\ID_pro3.mat') % 1.FID; 2.FIRST_ID_0; 3.ID_country120_0214; 4.FIRST_ID_1
load('H:\Global PV and wind\Data\GDP_PPP2015.mat'); % 2011 US dollar
load('H:\Global PV and wind\Data\GADM_pro120_xz.mat')  % 0-3638
for i = 1:192
    [m,n]=find(ID_pro(:,3)==i);
...
load('H:\Global PV and wind\Data\Area_country.mat') % km2
...
%%
load('H:\Global PV and wind\Data\GADM_country120_xz.mat')
...
save('H:\Global PV and wind\ANS\UHV_Station_country_all.mat', 'UHV_Station_country', '-v7.3')  % SubstatIon; row；col；country ID; region ID; pro ID(0-3638); power demand (TWh/year); REG(1-4)
...
save('H:\Global PV and wind\ANS\distance_UHV_Station_all.mat', 'distance_UHV_Station', '-v7.3')  % km
