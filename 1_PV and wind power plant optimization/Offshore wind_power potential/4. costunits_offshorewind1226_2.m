...
load('H:\global-PV-wind\Code\1_PV and wind power plant optimization\Offshore wind_power potential\ANS\ID_dist_offshore120_1227_xz2_xz_county.mat'); %
load('H:\global-PV-wind\Data\dist_id_pro120_1227_xz_county.mat'); % ID
% aa=unique(dist_id_pro120);
% aa1 = aa(2:end,1);
% clear aa
...
load('H:\global-PV-wind\Data\Wind_speed_100m_mean120.mat'); % m/s
Wind_speed_100m_mean120(find(isnan(Wind_speed_100m_mean120)==1))=0;


load('H:\global-PV-wind\Code\1_PV and wind power plant optimization\Offshore wind_power potential\ANS\offshorewind_power_all1227_xzz_county.mat'); % ,'Ph','-v7.3' kwh/year
...
save('H:\global-PV-wind\Code\1_PV and wind power plant optimization\Offshore wind_power potential\ANS\costunits_offshorewind1227_xz2_xz_county.dat','costunits_offshorewind');
