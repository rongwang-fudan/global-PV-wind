tic
clear;
load('H:\Global PV and wind\Code\1_PV and wind power plant optimization\Offshore wind_power potential\ANS\ID_dist_offshore120_1227_xz2_xz_county.mat'); % $/W
load('H:\Global PV and wind\Data\S_offshorewind_1227_xzz_county.mat');
load('H:\Global PV and wind\Code\1_PV and wind power plant optimization\Offshore wind_power potential\ANS\costunits_offshorewind1227_xz2_xz_county.dat','-mat');
...
bb1 = bb(2:end,1);
clear bb
load('H:\Global PV and wind\Data\pro_county.mat'); % 第一列是pro的ID，第二列是county
...
save('H:\Global PV and wind\Code\1_PV and wind power plant optimization\Offshore wind_power potential\ANS\off_ID_county_5%_100GW_.mat','off_ID','-v7.3'); % power plant ID,country,pro,county
save('H:\Global PV and wind\Code\1_PV and wind power plant optimization\Offshore wind_power potential\ANS\position_off_100GW_county_5%.mat','position_off','-v7.3'); % position of power plant
save('H:\Global PV and wind\Code\1_PV and wind power plant optimization\Offshore wind_power potential\ANS\r_unitid_lcoe_100GW_county_5%.mat','r_unitid_lcoe','-v7.3'); % 可利用面积最终确定的比例
save('H:\Global PV and wind\Code\1_PV and wind power plant optimization\Offshore wind_power potential\ANS\powers_offshorewind1227_2_xz_100GW_county_5%.mat','powers','-v7.3'); %
lcoe_offshorewind=powers(:,8);
save('H:\Global PV and wind\Code\1_PV and wind power plant optimization\Offshore wind_power potential\ANS\lcoe_offshorewind1227_2_xz_100GW_county_5%.mat','lcoe_offshorewind','-v7.3'); % USD2019/kWh
save('H:\Global PV and wind\Code\1_PV and wind power plant optimization\Offshore wind_power potential\ANS\unitid_lcoe_offshorewind1227_2_xz_100GW_county_5%.mat','unitid_lcoe','-v7.3'); %
azx = sum(sum(powers(:,6:7)))*10^6/(sum(sum(powers(:,3)))*10^3); %USD/W
powers(:,10)*10^6./(powers(:,3)*10^3);
save('H:\Global PV and wind\Code\1_PV and wind power plant optimization\Offshore wind_power potential\ANS\offshorewind_power_lcoemin1227_2_xz_100GW_county_5%.mat','offshorewind_power_lcoemin','-v7.3'); % power genration of each power plant
...
tic
clear
load('H:\Global PV and wind\Code\1_PV and wind power plant optimization\Offshore wind_power potential\ANS\powers_offshorewind1227_2_xz_100GW_county_5%.mat'); % USD2019/kWh
load('H:\Global PV and wind\Code\1_PV and wind power plant optimization\Offshore wind_power potential\ANS\position_off_100GW_county_5%.mat'); % power ID
load('H:\Global PV and wind\Code\1_PV and wind power plant optimization\Offshore wind_power potential\ANS\off_ID_county_5%_100GW_.mat'); % power ID

% 运行5.2 transmission_offshorewind

load('H:\Global PV and wind\Code\1_PV and wind power plant optimization\Offshore wind_power potential\ANS\tranmission_lines_100GW_county_5%.dat','-mat');
...
save('H:\Global PV and wind\Code\1_PV and wind power plant optimization\Offshore wind_power potential\ANS\optpowerunit_offshorewind_100GW_county_5%.mat','optpowerunit_offshorewind'); % power ID
save('H:\Global PV and wind\Code\1_PV and wind power plant optimization\Offshore wind_power potential\ANS\powerunit_IX_offshorewind_100GW_county_5%.mat','powerunit_IX_offshorewind'); % power ID
save('H:\Global PV and wind\Code\1_PV and wind power plant optimization\Offshore wind_power potential\ANS\tranmission_lines_IX_100GW_county_5%.mat','lines_IX'); %
save('H:\Global PV and wind\Code\1_PV and wind power plant optimization\Offshore wind_power potential\ANS\powerunit_num_IX_offshorewind_100GW_county_5%.mat','powerunit_num_IX_offshorewind'); %
save('H:\Global PV and wind\Code\1_PV and wind power plant optimization\Offshore wind_power potential\ANS\off_pro_IX_100GW_county_5%.mat','off_pro_IX'); %
