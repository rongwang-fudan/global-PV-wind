...
save('H:\global-PV-wind\Code\1_PV and wind power plant optimization\Offshore wind_power potential\ANS\S_offshorewind_1227_xzz_county2.mat','S_offshorewind','-v7.3');
...
save('H:\global-PV-wind\Code\1_PV and wind power plant optimization\Offshore wind_power potential\ANS\CP1227_xzz_county.mat','CP','-v7.3'); % kW
...
Other_coef=0.98;
load('H:\global-PV-wind\Code\1_PV and wind power plant optimization\Offshore wind_power potential\ANS\S_offshorewind_1227_xzz_county2.mat');
load('H:\global-PV-wind\Code\1_PV and wind power plant optimization\Offshore wind_power potential\ANS\CP1227_xzz_county.mat'); % kW
...
% S_offshorewind(sub2ind(size(S_offshorewind), m, n))= 0;
% save('H:\world1\code\数据处理\S_offshorewind12030.mat','S_offshorewind','-v7.3'); % kwh/h
...
load('H:\global-PV-wind\Data\CF_offshore_mean1224.mat'); % CF_offshore_mean1224
Ph = CP.*CF.*UTI_coef.*ARR_coef.*Ele_coef120.*Other_coef.*8760; % kwh/year
P_noCF = CP.*UTI_coef.*ARR_coef.*Ele_coef120.*Other_coef; % kwh/h
save('H:\global-PV-wind\Code\1_PV and wind power plant optimization\Offshore wind_power potential\ANS\offshorewind_power_all1227_xzz_county.mat','Ph','-v7.3'); % kwh/year
save('H:\global-PV-wind\Code\1_PV and wind power plant optimization\Offshore wind_power potential\ANS\P_noCF_offshorewind_county.mat','P_noCF','-v7.3'); % kwh/h
