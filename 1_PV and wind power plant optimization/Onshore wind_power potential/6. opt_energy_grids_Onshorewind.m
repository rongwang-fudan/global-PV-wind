...
% load('H:\world\code\数据处理\initialcost_ratio_country_0921low.mat')  % 1.PV 2.Onshorewind的成本与China的对比
load('H:\global-PV-wind\Data\initialcost_ratio_country_0111low.mat')  % 1.PV 2.Onshorewind的成本与China的对比
...
clear powerunit_w
load('H:\global-PV-wind\Code\1_PV and wind power plant optimization\Onshore wind_power potential\ANS\unitid_w_onshorewind_county_500MW.dat','-mat');
load('H:\global-PV-wind\Code\1_PV and wind power plant optimization\Onshore wind_power potential\ANS\unitid_all_w_onshorewind_county_500MW.dat','-mat');
unitid = unitid_w;
unitid_all = unitid_all_w;
clear unitid_w
clear unitid_all_w
load('H:\global-PV-wind\Code\1_PV and wind power plant optimization\Onshore wind_power potential\ANS\tranmission_lines_500MW_all.dat','-mat'); % lines
load('H:\global-PV-wind\Code\1_PV and wind power plant optimization\Onshore wind_power potential\ANS\costunits_500MW_2_all.dat','-mat');
numpowerunit=size(powerunit,1);
rmb2us=1/6.8967; % RMB to USD2019
% 组件价格1.58；集中逆变器0.115；固定式支架0.3；
% 建安费用0.62；一次设备0.39；二次设备0.085；
% 电缆设备0.22；土地成本0.2；电网接入费用0.24；管理费用0.24；
...
clear gridprice
clear otherprice
% moduleprice/moduleprice21
% consprice/moduleprice21
% gridprice/moduleprice21
% otherprice/moduleprice21
...
save('H:\global-PV-wind\Code\1_PV and wind power plant optimization\Onshore wind_power potential\ANS\lcoe_onshorewind_100GW_3_2_all_5%_inilow.mat','lcoe_onshorewind','-v7.3'); % USD2019/kWh
save('H:\global-PV-wind\Code\1_PV and wind power plant optimization\Onshore wind_power potential\ANS\CPPP111_onshorewind_100GW_3_2_all_5%_inilow.mat','CPPP111','-v7.3'); % 	MW
save('H:\global-PV-wind\Code\1_PV and wind power plant optimization\Onshore wind_power potential\ANS\powers_onshorewind_100GW_3_2_all_5%_inilow.mat','powers','-v7.3'); % USD2019/kWh
save('H:\global-PV-wind\Code\1_PV and wind power plant optimization\Onshore wind_power potential\ANS\unitid_lcoe_100GW_3_2_all_5%_inilow.dat','unitid_lcoe','-v7.3');
save('H:\global-PV-wind\Code\1_PV and wind power plant optimization\Onshore wind_power potential\ANS\unitid_lcoe_all_100GW_3_2_all_5%_inilow.dat','unitid_lcoe_all','-v7.3');
...
clear powerunit_w
load('H:\global-PV-wind\Code\1_PV and wind power plant optimization\Onshore wind_power potential\ANS\tranmission_lines_500MW_all.dat','-mat'); % lines
load('H:\global-PV-wind\Code\1_PV and wind power plant optimization\Onshore wind_power potential\ANS\CPPP111_onshorewind_100GW_3_2_all_5%_inilow.mat')
load('H:\global-PV-wind\Code\1_PV and wind power plant optimization\Onshore wind_power potential\ANS\powers_onshorewind_100GW_3_2_all_5%_inilow.mat')
load('H:\global-PV-wind\Code\1_PV and wind power plant optimization\Onshore wind_power potential\ANS\unitid_lcoe_100GW_3_2_all_5%_inilow.dat','-mat')

[B,IX]=sort(powers(:,20),1); %IX时powers(:,20)最小值到最大值的序号
...
save('H:\global-PV-wind\Code\1_PV and wind power plant optimization\Onshore wind_power potential\ANS\CPPP111_onshorewind_IX_100GW_3_2_all_5%_inilow.mat','CPPP111_IX','-v7.3'); % 	MW
save('H:\global-PV-wind\Code\1_PV and wind power plant optimization\Onshore wind_power potential\ANS\optpowerunit_onshorewind_100GW_3_2_all_5%_inilow.mat','optpowerunit_onshorewind','-v7.3'); % power ID
powerunit_IX_onshorewind = powerunit_IX;
save('H:\global-PV-wind\Code\1_PV and wind power plant optimization\Onshore wind_power potential\ANS\powerunit_IX_onshorewind_100GW_3_2_all_5%_inilow.mat','powerunit_IX_onshorewind','-v7.3'); % power ID
save('H:\global-PV-wind\Code\1_PV and wind power plant optimization\Onshore wind_power potential\ANS\tranmission_lines_IX_100GW_3_2_all_5%_inilow.mat','lines_IX','-v7.3'); %
powerunit_num_IX_onshorewind = powerunit_num_IX;
save('H:\global-PV-wind\Code\1_PV and wind power plant optimization\Onshore wind_power potential\ANS\powerunit_num_IX_onshorewind_100GW_3_2_all_5%_inilow.mat','powerunit_num_IX_onshorewind','-v7.3'); %
