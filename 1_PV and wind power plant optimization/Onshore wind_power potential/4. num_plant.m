...
save('H:\global-PV-wind\Code\1_PV and wind power plant optimization\Onshore wind_power potential\ANS\powerdemand_plant_ons_all.mat', 'powerdemand_plant_ons', '-v7.3')  % 各电厂分配的power demand (TWh/year)，该区域有UHV的地方才有需电量
save('H:\global-PV-wind\Code\1_PV and wind power plant optimization\Onshore wind_power potential\ANS\REG_plant_ons_all.mat', 'REG_plant_ons', '-v7.3')  % 各电厂所在的国家，REG的ID， UHV Station的ID
