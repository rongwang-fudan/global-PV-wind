tic
clear;
load('H:\global-PV-wind\Code\1_PV and wind power plant optimization\Onshore wind_power potential\ANS\position_county_onshorewind_500MW_sameC.dat','-mat');
...
for iii = 1:max(max(GADM_country120))
    coun = iii;
    load(strcat('H:\global-PV-wind\Code\1_PV and wind power plant optimization\Onshore wind_power potential\ANS\powerunit_',num2str(coun),'_sameC.mat'));
    load(strcat('H:\global-PV-wind\Code\1_PV and wind power plant optimization\Onshore wind_power potential\ANS\unitid_',num2str(coun),'_sameC.mat'));
    load(strcat('H:\global-PV-wind\Code\1_PV and wind power plant optimization\Onshore wind_power potential\ANS\unitid_all_',num2str(coun),'_sameC.mat'));
    load(strcat('H:\global-PV-wind\Code\1_PV and wind power plant optimization\Onshore wind_power potential\ANS\unitid_cy_',num2str(coun),'_sameC.mat'));
...
save('H:\global-PV-wind\Code\1_PV and wind power plant optimization\Onshore wind_power potential\ANS\unitid_w_onshorewind_county_500MW.dat','unitid_w');
save('H:\global-PV-wind\Code\1_PV and wind power plant optimization\Onshore wind_power potential\ANS\unitid_all_w_onshorewind_county_500MW.dat','unitid_all_w');
save('H:\global-PV-wind\Code\1_PV and wind power plant optimization\Onshore wind_power potential\ANS\unitid_cy_w_onshorewind_county_500MW.dat','unitid_cy_w');
save('H:\global-PV-wind\Code\1_PV and wind power plant optimization\Onshore wind_power potential\ANS\powerunit_w_onshorewind_county_500MW.dat','powerunit_w');
