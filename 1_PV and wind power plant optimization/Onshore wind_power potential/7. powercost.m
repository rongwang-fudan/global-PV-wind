...
% ENERGY Production 2
load('H:\Global PV and wind\Data\CP_wind_120_all_2.mat'); % CP_PV_120_all(4800x1950)
...
load('H:\world\code\数据处理\Onshorewind\final0325\suitableland_onshorewind_sameC.mat')
...
load('H:\Global PV and wind\Data\E_120cy_ori.mat')  % GWh/day/county各国家的各县分配的power demand
load('H:\Global PV and wind\Data\Gasoline_120cy_ori.mat')  % GWh/day/county各国家的各县分配的power demand
load('H:\Global PV and wind\Data\Diesel_120cy_ori.mat')  % GWh/day/county 各国家的各县分配的power demand
...
save('H:\Global PV and wind\Code\1_PV and wind power plant optimization\Onshore wind_power potential\ANS\costunits_500MW_2_all.dat','costs','-v7.3');
