...
tic
clear;
load('H:\Global PV and wind\ANS\B_UHV_STO_INT_county_all_withUHVcost_pro2_8_2070_2s_2060s_test6.mat')  % B_utilize_trans_storage
load('H:\Global PV and wind\ANS\unitmin_global_IX_county0811_all_cou_5%_LRglobal_inilow_pro2_8_2070.mat');
load('H:\Global PV and wind\ANS\optpowerunit_IX_8_2070_2s_2060s_test6.mat'); %optpowerunit_IX
...
% silicon
[m,n]=find(optpowerunit_IX(:,35)==1 & unitmin==10 & B_utilize_trans_storage<=130.85);
...
save('H:\Global PV and wind\ANS\unitmin_global_IX_county0811_all_cou_5%_LRglobal_inilow_pro2_8_2070xz.mat','unitmin');
