...
%%
load('H:\global-PV-wind\ANS\CO2_mecha_county_all_pro_8_2070.mat'); % USD2019/kWh
load('H:\global-PV-wind\ANS\B_mecha_county_all_pro_8_2070.mat'); % USD2019/kWh
load('H:\global-PV-wind\ANS\LCOEE_mecha_county_all_pro_8_2070.mat'); % USD2019/kWh
CO2_mecha = CO2all_c_utilize_trans_storage;
B_mecha = B_utilize_trans_storage;
LCOE_mecha = LCOEE_all_utilize_trans_storage;

load('H:\global-PV-wind\ANS\CO2_Battery_county_all_pro_8_2070.mat'); % USD2019/kWh
load('H:\global-PV-wind\ANS\B_Battery_county_all_pro_8_2070.mat'); % USD2019/kWh
load('H:\global-PV-wind\ANS\LCOEE_Battery_county_all_pro_8_2070.mat'); % USD2019/kWh
...
save('H:\global-PV-wind\ANS\cho_county_all_pro_8_2070.mat','cho'); % 

CHO_ALL = optpowerunit_IX(:,35);
CHO_ALL(:,2) = optpowerunit_IX(:,40);
CHO_ALL(:,3) = cho;
save('H:\global-PV-wind\ANS\CHO_ALL_pro_8_2070.mat','CHO_ALL'); % 
