...
clear position_c
save('H:\Global PV and wind\ANS\distance_CN_8_2070_nointerUHV.mat','distance_CN') % km
%%
...
for i = 1:1:numpowerunit
    if rem(i,1000)==1 && floor(i/1000)~=0
        filename = strcat('H:\Global PV and wind\ANS\linescapacity_plant',num2str((i-1)/1000),'_battery_mechanical_pro1_8_2070_nointerUHV.mat');
...
filename = strcat('H:\Global PV and wind\ANS\linescapacity_plant',num2str(ceil(i/1000)),'_battery_mechanical_pro1_8_2070_nointerUHV.mat');
save(filename, 'linescapacity_plant','-v7.3');
2
% domestic storage
nnnn = 0;
load('H:\Global PV and wind\ANS\linescapacity_plant1_battery_mechanical_pro1_8_2070_nointerUHV.mat')% million $
for i = 1: 1:numpowerunit
    if rem(i,1000)==1 && floor(i/1000)~=0
        filename = strcat('H:\Global PV and wind\ANS\linescapacity_plant',num2str((i-1)/1000),'_battery_mechanical_pro_8_2070_nointerUHV.mat');
        save(filename, 'linescapacity_plant','-v7.3');
        filename = strcat('H:\Global PV and wind\ANS\linescapacity_plant',num2str((i-1)/1000+1),'_battery_mechanical_pro1_8_2070_nointerUHV.mat');
        load(filename);
        nnnn = floor(i/1000);
    end
    i2=i;
...
filename = strcat('H:\Global PV and wind\ANS\linescapacity_plant',num2str(ceil(i/1000)),'_battery_mechanical_pro_8_2070_nointerUHV.mat');
save(filename, 'linescapacity_plant','-v7.3');
save('H:\Global PV and wind\ANS\linescapacity_plant_battery_mechanical_CN_pro_8_2070_nointerUHV.mat','linescapacity_plant_CN','-v7.3')% million $
...
save('H:\Global PV and wind\ANS\etrans_all_battery_mechanical_pro2_8_2070_nointerUHV.mat','etrans1')% 实际有效发电量, TWh/year
save('H:\Global PV and wind\ANS\etrans_type_all_battery_mechanical_pro2_8_2070_nointerUHV.mat','etrans_type1')%
save('H:\Global PV and wind\ANS\etrans_cou_all_battery_mechanical_pro2_8_2070_nointerUHV.mat','etrans_cou1')%
save('H:\Global PV and wind\ANS\etrans_cou_type_all_battery_mechanical_pro2_8_2070_nointerUHV.mat','etrans_cou_type1')%
save('H:\Global PV and wind\ANS\etrans_REG_all_battery_mechanical_pro2_8_2070_nointerUHV.mat','etrans_REG1')%
save('H:\Global PV and wind\ANS\etrans_REG_type_all_battery_mechanical_pro2_8_2070_nointerUHV.mat','etrans_REG_type1')%

save('H:\Global PV and wind\ANS\etrans_all_battery_mechanical_withoutPUE_pro2_8_2070_nointerUHV.mat','etrans')% 不考虑用电效率的发电量, TWh/year
save('H:\Global PV and wind\ANS\etrans_type_all_battery_mechanical_withoutPUE_pro2_8_2070_nointerUHV.mat','etrans_type')%
save('H:\Global PV and wind\ANS\etrans_cou_all_battery_mechanical_withoutPUE_pro2_8_2070_nointerUHV.mat','etrans_cou')%
save('H:\Global PV and wind\ANS\etrans_cou_type_all_battery_mechanical_withoutPUE_pro2_8_2070_nointerUHV.mat','etrans_cou_type')%
save('H:\Global PV and wind\ANS\etrans_REG_all_battery_mechanical_withoutPUE_pro2_8_2070_nointerUHV.mat','etrans_REG')%
save('H:\Global PV and wind\ANS\etrans_REG_type_all_battery_mechanical_withoutPUE_pro2_8_2070_nointerUHV.mat','etrans_REG_type')%

save('H:\Global PV and wind\ANS\powerall_reg_pro2_8_2070_nointerUHV.mat','powerall_reg')% 不考虑用电效率的发电量, TWh/year
...
save('H:\Global PV and wind\ANS\power3_reg_pro2_8_2070_nointerUHV.mat','power3')% 3*11，自用,他用和废弃实际发电量, TWh/year
save('H:\Global PV and wind\ANS\utilize_ratio2060_UHV_storage_inter_county_all_battery_mechanical_pro2_8_2070_nointerUHV.mat','utilize_ratio2060_UHV_storage_inter')
...
save('H:\Global PV and wind\ANS\linescapacity_all_battery_mechanical_pro2_8_2070_nointerUHV.mat','linescapacity')%
save('H:\Global PV and wind\ANS\linescapacity_all_battery_mechanical_CN_pro2_8_2070_nointerUHV.mat','linescapacity_CN')%
...
save('H:\Global PV and wind\ANS\CP_fix_8_2070_nointerUHV.mat','CP_fix') % km
...
save('H:\Global PV and wind\ANS\cost_l_all_battery_mechanical_all_pro2_8_2070_nointerUHV.mat','cost_l_all')% million $
save('H:\Global PV and wind\ANS\cost_l_all_battery_mechanical_all_CN_pro2_8_2070_nointerUHV.mat','cost_l_all_CN')% million $
save('H:\Global PV and wind\ANS\Type_UHV_battery_mechanical_all_pro2_8_2070_nointerUHV.mat','Type_UHV')% million $
...
% 有很多线路运输很少的电，经济上不划算
save('H:\Global PV and wind\ANS\powergenerat_monhour_plant_county_battery_mechanical_all_pro2_8_2070_nointerUHV.mat','powergenerat_monhour_plant')

save('H:\Global PV and wind\ANS\P_pro1_county_battery_mechanical_all_pro2_8_2070_nointerUHV.mat','P_REG1')
save('H:\Global PV and wind\ANS\P_country1_county_battery_mechanical_all_pro2_8_2070_nointerUHV.mat','P_country1')
save('H:\Global PV and wind\ANS\P_country2_county_battery_mechanical_all_pro2_8_2070_nointerUHV.mat','P_country2')
save('H:\Global PV and wind\ANS\P_region2_county_battery_mechanical_all_pro2_8_2070_nointerUHV.mat','P_region2')
save('H:\Global PV and wind\ANS\P_world_county_battery_mechanical_all_pro2_8_2070_nointerUHV.mat','P_world')

save('H:\Global PV and wind\ANS\utilize_ratio2060_county_battery_mechanical_all_pro2_8_2070_nointerUHV.mat','utilize_ratio2060')
save('H:\Global PV and wind\ANS\utilize_ratio2060_UHV_county_battery_mechanical_all_pro2_8_2070_nointerUHV.mat','utilize_ratio2060_UHV')
save('H:\Global PV and wind\ANS\utilize_ratio2060_UHV_storage_county_battery_mechanical_all_pro2_8_2070_nointerUHV.mat','utilize_ratio2060_UHV_storage')
save('H:\Global PV and wind\ANS\utilize_ratio2060_UHV_storage_reg_county_battery_mechanical_all_pro2_8_2070_nointerUHV.mat','utilize_ratio2060_UHV_storage_reg')
save('H:\Global PV and wind\ANS\utilize_ratio2060_UHV_storage_inter_county_battery_mechanical_all_pro2_8_2070_nointerUHV.mat','utilize_ratio2060_UHV_storage_inter')

save('H:\Global PV and wind\ANS\storage_max_plant_UHV_storage_county_battery_mechanical_all_pro2_8_2070_nointerUHV.mat','storage_max_plant_UHV_storage')   % TWh/h
save('H:\Global PV and wind\ANS\storage_year_plant_UHV_storage_county_battery_mechanical_all_pro2_8_2070_nointerUHV.mat','storage_year_plant_UHV_storage')  % TWh/year
save('H:\Global PV and wind\ANS\storage_max_plant_UHV_storage_reg_county_battery_mechanical_all_pro2_8_2070_nointerUHV.mat','storage_max_plant_UHV_storage_reg')   % TWh/h
save('H:\Global PV and wind\ANS\storage_year_plant_UHV_storage_reg_county_battery_mechanical_all_pro2_8_2070_nointerUHV.mat','storage_year_plant_UHV_storage_reg')  % TWh/year
save('H:\Global PV and wind\ANS\storage_max_plant_UHV_storage_inter_county_battery_mechanical_all_pro2_8_2070_nointerUHV.mat','storage_max_plant_UHV_storage_inter')   % TWh/h
save('H:\Global PV and wind\ANS\storage_year_plant_UHV_storage_inter_county_battery_mechanical_all_pro2_8_2070_nointerUHV.mat','storage_inter_year_plant_UHV_storage')  % TWh/year

%%
linescapacity_plant_all = zeros(size(distance_UHV_Station,1),size(distance_UHV_Station,1));
for n = 1:1:nnnn+1
    filename = strcat('H:\Global PV and wind\ANS\linescapacity_plant',num2str(n),'_battery_mechanical_pro_8_2070_nointerUHV.mat');
    load(filename);
...
save('H:\Global PV and wind\ANS\cost_trans_IX_battery_mechanical_all_pro2_8_2070_nointerUHV.mat','cost_trans_IX')% million $
save('H:\Global PV and wind\ANS\CP_trans_IX_battery_mechanical_all_pro2_8_2070_nointerUHV.mat','CP_trans_IX')% million $
save('H:\Global PV and wind\ANS\cost_trans_IX_cou2_8_2070_nointerUHV.mat','cost_trans_IX_cou')% million $
