...
Ph_country = sum(a,2);
% save('H:\global-PV-wind\ANS\Ph_country.mat','Ph_country'); % TWh/year
...
%     end
    time
    filename = strcat('H:\global-PV-wind\ANS\learnprice_region_county0811_all_2_pro',num2str(time+1),'2_8_2070.mat');
