...
save('H:\Global PV and wind\ANS\choo_type_8_2070xz_CaseB.mat','choo'); 
...
load('H:\Global PV and wind\ANS\choo_type_8_2070xz_CaseB.mat'); % choo
for i = 1:2
    [m,n]=find(choo==i);
...
save('H:\Global PV and wind\ANS\utilize_ratio_8_2070_xzxz_CaseB.mat','utilize_ratio2060_UHV_storage_inter'); 
save('H:\Global PV and wind\ANS\cost_trans_8_2070_xzxz_CaseB.mat','cost_trans_IX'); 
save('H:\Global PV and wind\ANS\CP_trans_8_2070_xzxz_CaseB.mat','CP_trans_IX'); 
save('H:\Global PV and wind\ANS\storage_max_plant_8_2070_xzxz_CaseB.mat','storage_max_plant_UHV_storage_inter'); 
save('H:\Global PV and wind\ANS\storage_year_plant_8_2070_xzxz_CaseB.mat','storage_inter_year_plant_UHV_storage'); 
