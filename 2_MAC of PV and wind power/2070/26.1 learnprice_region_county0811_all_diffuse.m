...
% load('H:\global-PV-wind\Data\powerdemand_monhour2060_ele_0327.mat')  %  TWh/h
...
load('H:\global-PV-wind\Code\1_PV and wind power plant optimization\Offshore wind_power potential\ANS\unitid_lcoe_offshorewind1227_2_xz_100GW_county_5%.mat');
...
for time = 1:1:10
    ...
    for i = 1:6
        for reg = 1:8
            ...
            if size(m2,1)==1
                index_cou(time,i,reg) = m2;
            else if size(m2,1)==size(mmm,1)
                index_cou(time,i,reg) = 0;
            else if size(m2,1)<size(mmm,1) & size(m2,1)>1
                index_cou(time,i,reg) = m2(1);
                end
                end
            end
    ...
    filename = strcat('H:\global-PV-wind\ANS\learnprice_region_county0811_all_2_pro',num2str(time+1),'2_192xz.mat');
    save(filename, 'learnprice_region_d192','-v7.3');
    time
end
save('H:\global-PV-wind\ANS\index_cou_2070xz.mat','index_cou');
clear learnprice_region
learnprice_region1 = learnprice_region2(:,:,1:11);
% save('H:\global-PV-wind\ANS\learn_country_diffuse_8_2070xz.mat','learn_country'); % 10 regions * 6
...
save('H:\global-PV-wind\ANS\learnprice_region_county0811_all_2_diffuse_pro22_8_2070xz.mat','learnprice_region'); % 10 regions * 6
...
save('H:\global-PV-wind\ANS\learnprice_region_county0811_all_2_diffuse_pro32_8_2070xz.mat','learnprice_region'); %
...
save('H:\global-PV-wind\ANS\learnprice_region_county0811_all_2_diffuse_pro42_8_2070xz.mat','learnprice_region'); %
...
save('H:\global-PV-wind\ANS\learnprice_region_county0811_all_2_diffuse_pro52_8_2070xz.mat','learnprice_region'); %
...
save('H:\global-PV-wind\ANS\learnprice_region_county0811_all_2_diffuse_pro62_8_2070xz.mat','learnprice_region'); %
...
save('H:\global-PV-wind\ANS\learnprice_region_county0811_all_2_diffuse_pro72_8_2070xz.mat','learnprice_region'); %
...
save('H:\global-PV-wind\ANS\learnprice_region_county0811_all_2_diffuse_pro82_8_2070xz.mat','learnprice_region'); %
...
save('H:\global-PV-wind\ANS\learnprice_region_county0811_all_2_diffuse_pro92_8_2070xz.mat','learnprice_region'); %
...
save('H:\global-PV-wind\ANS\learnprice_region_county0811_all_2_diffuse_pro102_8_2070xz.mat','learnprice_region'); %
...
save('H:\global-PV-wind\ANS\learnprice_region_county0811_all_2_diffuse_pro112_8_2070xz.mat','learnprice_region'); %
