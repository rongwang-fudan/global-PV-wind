...
Ph_country = sum(a,2);
% save('H:\Global PV and wind\ANS\Ph_country.mat','Ph_country'); % TWh/year
...
for time = 1:1:10
    ...
    %%
    time
    filename = strcat('H:\Global PV and wind\ANS\learnprice_region_county0811_all_2_pro',num2str(time+1),'2_8_2070xz.mat');
