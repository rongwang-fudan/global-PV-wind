...
load('H:\Global PV and wind\ANS\utilize_ratio2060_UHV_storage_inter_county_all_pro.mat')  % power use efficiency with global electric transport and storage
...
load('H:\Global PV and wind\ANS\storage_max_plant_UHV_storage_inter_county_all_pro.mat')   % Maximum charging power, TWh/h  
load('H:\Global PV and wind\ANS\storage_year_plant_UHV_storage_inter_county_all_pro.mat')  % Average annual electricity storage, TWh/year
...
save('H:\Global PV and wind\ANS\LCOEE_Battery_county_all_pro_8_2070.mat','LCOEE_all_utilize_trans_storage', '-v7.3')  % billion kWh / year
...
save('H:\Global PV and wind\ANS\CP_UHV_STO_INT_pro_8_2070.mat','CP', '-v7.3')  % billion kWh / year
save('H:\Global PV and wind\ANS\CO2_UHV_STO_INT_pro_8_2070.mat','CO2all_c_utilize_trans_storage', '-v7.3')  % billion kWh / year
save('H:\Global PV and wind\ANS\B_UHV_STO_INT_pro_8_2070.mat','B_utilize_trans_storage', '-v7.3')  % billion kWh / year

[B_utilize_trans_storage_IX,IX]=sort(B_utilize_trans_storage);

%%
save('H:\Global PV and wind\ANS\CO2_Battery_county_all_pro_8_2070.mat','CO2all_c_utilize_trans_storage'); % USD2019/kWh
save('H:\Global PV and wind\ANS\B_Battery_county_all_pro_8_2070.mat','B_utilize_trans_storage'); % USD2019/kWh
...
save('H:\Global PV and wind\ANS\CO2_Battery_ix_county_all_pro_8_2070.mat','CO2all2_c22_utilize_trans_storage_IX2'); % USD2019/kWh
save('H:\Global PV and wind\ANS\B_Battery_ix_county_all_pro_8_2070.mat','B22_utilize_trans_storage_IX2'); % USD2019/kWh
