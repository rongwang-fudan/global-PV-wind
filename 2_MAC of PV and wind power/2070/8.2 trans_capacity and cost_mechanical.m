...
% load('H:\world\code\P2070_others.mat'); % TWh/year
...
powerdemand_monhour2060_ele288_country = zeros(288,192);
% ind1 = [];
for i = 1:192
    [m,n]=find(ID_pro(:,3)==i);
    ind = unique(ID_pro(m,1)+1);
%     ind1 = [ind1;ind];
    powerdemand_monhour2060_ele288_country(:,i) = sum(powerdemand_monhour2070_ele288(:,ind),2);
...
for i = 1:192
    powerdemand_monhour(:,i) = powerdemand_monhour2060_ele288_country(:,i)-P2019_others(i,1)/8760;
    i
end
...
% load('H:\world\code\powerdemand_monhour2070_REG0811_2_1112.mat')  % 288*size(distance_UHV_Station,1), TWh/h，去除其他清洁能源需电量（2020年实际发电量）
...
ef3 = 0.7; % power loss rate during charge, discharge and mechanical storage period
...
save('H:\global-PV-wind\ANS\utilize_ratio2060_county_mechanical_all_pro.mat','utilize_ratio2060') 
save('H:\global-PV-wind\ANS\utilize_ratio2060_UHV_county_mechanical_all_pro.mat','utilize_ratio2060_UHV') 
save('H:\global-PV-wind\ANS\utilize_ratio2060_UHV_storage_county_mechanical_all_pro.mat','utilize_ratio2060_UHV_storage') 
save('H:\global-PV-wind\ANS\utilize_ratio2060_UHV_storage_reg_county_mechanical_all_pro.mat','utilize_ratio2060_UHV_storage_reg') 
save('H:\global-PV-wind\ANS\utilize_ratio2060_UHV_storage_inter_county_mechanical_all_pro.mat','utilize_ratio2060_UHV_storage_inter') 

save('H:\global-PV-wind\ANS\storage_max_plant_UHV_storage_county_mechanical_all_pro.mat','storage_max_plant_UHV_storage')   % TWh/h  
save('H:\global-PV-wind\ANS\storage_year_plant_UHV_storage_county_mechanical_all_pro.mat','storage_year_plant_UHV_storage')  % TWh/year
save('H:\global-PV-wind\ANS\storage_max_plant_UHV_storage_reg_county_mechanical_all_pro.mat','storage_max_plant_UHV_storage_reg')   % TWh/h  
save('H:\global-PV-wind\ANS\storage_year_plant_UHV_storage_reg_county_mechanical_all_pro.mat','storage_year_plant_UHV_storage_reg')  % TWh/year
save('H:\global-PV-wind\ANS\storage_max_plant_UHV_storage_inter_county_mechanical_all_pro.mat','storage_max_plant_UHV_storage_inter')   % TWh/h  
save('H:\global-PV-wind\ANS\storage_year_plant_UHV_storage_inter_county_mechanical_all_pro.mat','storage_inter_year_plant_UHV_storage')  % TWh/year
