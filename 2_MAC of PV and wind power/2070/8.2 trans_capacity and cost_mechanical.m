...
save('H:\Global PV and wind\ANS\utilize_ratio2060_county_mechanical_all_pro.mat','utilize_ratio2060') 
save('H:\Global PV and wind\ANS\utilize_ratio2060_UHV_county_mechanical_all_pro.mat','utilize_ratio2060_UHV') 
save('H:\Global PV and wind\ANS\utilize_ratio2060_UHV_storage_county_mechanical_all_pro.mat','utilize_ratio2060_UHV_storage') 
save('H:\Global PV and wind\ANS\utilize_ratio2060_UHV_storage_reg_county_mechanical_all_pro.mat','utilize_ratio2060_UHV_storage_reg') 
save('H:\Global PV and wind\ANS\utilize_ratio2060_UHV_storage_inter_county_mechanical_all_pro.mat','utilize_ratio2060_UHV_storage_inter') 

save('H:\Global PV and wind\ANS\storage_max_plant_UHV_storage_county_mechanical_all_pro.mat','storage_max_plant_UHV_storage')   % TWh/h  
save('H:\Global PV and wind\ANS\storage_year_plant_UHV_storage_county_mechanical_all_pro.mat','storage_year_plant_UHV_storage')  % TWh/year
save('H:\Global PV and wind\ANS\storage_max_plant_UHV_storage_reg_county_mechanical_all_pro.mat','storage_max_plant_UHV_storage_reg')   % TWh/h  
save('H:\Global PV and wind\ANS\storage_year_plant_UHV_storage_reg_county_mechanical_all_pro.mat','storage_year_plant_UHV_storage_reg')  % TWh/year
save('H:\Global PV and wind\ANS\storage_max_plant_UHV_storage_inter_county_mechanical_all_pro.mat','storage_max_plant_UHV_storage_inter')   % TWh/h  
save('H:\Global PV and wind\ANS\storage_year_plant_UHV_storage_inter_county_mechanical_all_pro.mat','storage_inter_year_plant_UHV_storage')  % TWh/year
