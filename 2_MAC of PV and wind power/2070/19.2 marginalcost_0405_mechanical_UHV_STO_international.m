...
load('H:\global-PV-wind\ANS\utilize_ratio2060_UHV_storage_inter_county_mechanical_all_pro2_8_2070.mat')  % power use efficiency with global electric transport and storage
...
cost_trans = utilize_ratio2060*0;
CP_trans = utilize_ratio2060*0;


% load('H:\global-PV-wind\ANS\storage_max_plant_UHV_storage.mat')   % Maximum charging power, TWh/h  
% load('H:\global-PV-wind\ANS\storage_year_plant_UHV_storage.mat')  % Average annual electricity storage, TWh/year
...
% load('H:\global-PV-wind\ANS\storage_max_plant_UHV_storage_reg.mat')   % Maximum charging power, TWh/h  
% load('H:\global-PV-wind\ANS\storage_year_plant_UHV_storage_reg.mat')  % Average annual electricity storage, TWh/year
...
load('H:\global-PV-wind\ANS\storage_max_plant_UHV_storage_inter_county_mechanical_all_pro2_8_2070.mat')   % Maximum charging power, TWh/h  
load('H:\global-PV-wind\ANS\storage_year_plant_UHV_storage_inter_county_mechanical_all_pro2_8_2070.mat')  % Average annual electricity storage, TWh/year
...
lcoeeall_utilize_trans_storage(:,11) = lcoeeall_utilize_trans_storage(:,11)*0;


LCOEE_all_utilize_trans_storage = (sum(lcoeeall_utilize_trans_storage(:,1:11),2)+Cost_storage)./phhall_utilize_trans_storage(:,1)/1000; % LCoE million USD2019/TWh->USD2019/kWh   ;            
...
save('H:\global-PV-wind\ANS\LCOEE_mecha_county_all_pro2_8_2070_wUHV.mat','LCOEE_all_utilize_trans_storage', '-v7.3')  % billion kWh / year
...
% 
% load('H:\global-PV-wind\ANS\EF_coal.mat'); % kg CO2/kWh
% load('H:\global-PV-wind\ANS\EF_gas.mat'); % kg CO2/kWh
% load('H:\global-PV-wind\ANS\EF_oil.mat'); % kg CO2/kWh
% load('H:\global-PV-wind\ANS\Price_coal.mat'); % USD/kWh, 第一列是均值，第二列std
% load('H:\global-PV-wind\ANS\Price_gas.mat'); % USD/kWh, 第一列是均值，第二列std
% load('H:\global-PV-wind\ANS\Price_oil.mat'); % USD/kWh, 第一列是均值，第二列std
% for i = 1:192
...
% end
% save('H:\global-PV-wind\ANS\EP_8_2070_xz_mechanical_wUHV.mat','EP'); 
% save('H:\global-PV-wind\ANS\emissionfactor_8_2070_xz_mechanical_wUHV.mat','emissionfactor'); 
% clear ixx_2_1
...
% clear Index2
% clear Index3
load('H:\global-PV-wind\ANS\EP_8_2070_xz_battery.mat','EP'); 
load('H:\global-PV-wind\ANS\emissionfactor_8_2070_xz_battery.mat','emissionfactor'); 
...
B_utilize_trans_storage = (sum(lcoeeall_utilize_trans_storage(:,1:11),2)+Cost_storage-phhall_utilize_trans_storage(:,1).*EP*10^3)./(-CO2_all_utilize_trans_storage); %USD/t CO2
B_utilize_trans_storage_Sto = Cost_storage./(-CO2_all_utilize_trans_storage); %USD/t CO2
LCOEE_utilize_trans_storage = (sum(lcoeeall_utilize_trans_storage(:,1:11),2)+Cost_storage)./phhall_utilize_trans_storage(:,1)/1000; % LCoE million USD2019/TWh->USD2019/kWh   ;            
% save('H:\global-PV-wind\ANS\LCOE_UHV_STO_INT2_8_2070_wUHV.mat','LCOEE_all_utilize_trans_storage', '-v7.3')  % billion kWh / year
phhall_utilize_trans_storage111 = phhall_utilize_trans_storage(:,1);
% save('H:\global-PV-wind\ANS\Ph_UHV_STO_reg2_8_2070_wUHV.mat','phhall_utilize_trans_storage111', '-v7.3')  % billion kWh / year
cost = sum(lcoeeall_utilize_trans_storage(:,1:11),2)+Cost_storage;
% save('H:\global-PV-wind\ANS\costtt_UHV_STO_reg2_8_2070_wUHV.mat','cost', '-v7.3')  % 
...
% save('H:\global-PV-wind\ANS\CP_UHV_STO_INT2_8_2070_wUHV.mat','CP', '-v7.3')  % billion kWh / year
% save('H:\global-PV-wind\ANS\CO2_UHV_STO_INT2_8_2070_wUHV.mat','CO2all_c_utilize_trans_storage', '-v7.3')  % billion kWh / year
% save('H:\global-PV-wind\ANS\B_UHV_STO_INT2_8_2070_wUHV.mat','B_utilize_trans_storage', '-v7.3')  % billion kWh / year
% save('H:\global-PV-wind\ANS\CO2_PV_year_STO_INT2_8_2070_wUHV.mat','CO2_PV_year', '-v7.3')  % billion kWh / year
% save('H:\global-PV-wind\ANS\CO2_onshorewind_year_STO_INT2_8_2070_wUHV.mat','CO2_onshorewind_year', '-v7.3')  % billion kWh / year
% save('H:\global-PV-wind\ANS\CO2_offshorewind_year_STO_INT2_8_2070_wUHV.mat','CO2_offshorewind_year', '-v7.3')  % billion kWh / year

% save('H:\global-PV-wind\ANS\CP_UHV_STO_reg2_8_2070_wUHV.mat','CP', '-v7.3')  % billion kWh / year
% save('H:\global-PV-wind\ANS\CO2_UHV_STO_reg2_8_2070_wUHV.mat','CO2all_c_utilize_trans_storage', '-v7.3')  % billion kWh / year
% save('H:\global-PV-wind\ANS\B_UHV_STO_reg2_8_2070_wUHV.mat','B_utilize_trans_storage', '-v7.3')  % billion kWh / year
% save('H:\global-PV-wind\ANS\CP_UHV_STO2_8_2070_wUHV.mat','CP', '-v7.3')  % billion kWh / year
% save('H:\global-PV-wind\ANS\CO2_UHV_STO2_8_2070_wUHV.mat','CO2all_c_utilize_trans_storage', '-v7.3')  % billion kWh / year
% save('H:\global-PV-wind\ANS\B_UHV_STO2_8_2070_wUHV.mat','B_utilize_trans_storage', '-v7.3')  % billion kWh / year

% % save('H:\global-PV-wind\ANS\CO2_UHV_STO_INT_pv2_8_2070_wUHV.mat','CO2all_c_utilize_trans_storage_pv', '-v7.3')  % billion kWh / year
% % save('H:\global-PV-wind\ANS\B_UHV_STO_INT_pv2_8_2070_wUHV.mat','B_utilize_trans_storage_pv', '-v7.3')  % billion kWh / year
% % 
% % save('H:\global-PV-wind\ANS\CO2_UHV_STO_INT_ons2_8_2070_wUHV.mat','CO2all_c_utilize_trans_storage_onshorewind', '-v7.3')  % billion kWh / year
% % save('H:\global-PV-wind\ANS\B_UHV_STO_INT_ons2_8_2070_wUHV.mat','B_utilize_trans_storage_onshorewind', '-v7.3')  % billion kWh / year
% % 
% % save('H:\global-PV-wind\ANS\CO2_UHV_STO_INT_off2_8_2070_wUHV.mat','CO2all_c_utilize_trans_storage_offshorewind', '-v7.3')  % billion kWh / year
% % save('H:\global-PV-wind\ANS\B_UHV_STO_INT_off2_8_2070_wUHV.mat','B_utilize_trans_storage_offshorewind', '-v7.3')  % billion kWh / year

[B_utilize_trans_storage_IX,IX]=sort(B_utilize_trans_storage);
% save('H:\global-PV-wind\ANS\IX_UHV_STO_INT2_8_2070_wUHV.mat','IX', '-v7.3')  % 
...
%%
save('H:\global-PV-wind\ANS\CO2_mecha_county_all_pro2_8_2070_wUHV.mat','CO2all_c_utilize_trans_storage'); % USD2019/kWh
save('H:\global-PV-wind\ANS\B_mecha_county_all_pro2_8_2070_wUHV.mat','B_utilize_trans_storage'); % USD2019/kWh
save('H:\global-PV-wind\ANS\B_sto_mecha_county_all_pro2_8_2070_wUHV.mat','B_utilize_trans_storage_Sto', '-v7.3')  % billion kWh / year
...
save('H:\global-PV-wind\ANS\CO2_mecha_ix_county_all_pro2_8_2070_wUHV.mat','CO2all2_c22_utilize_trans_storage_IX2'); % USD2019/kWh
save('H:\global-PV-wind\ANS\B_mecha_ix_county_all_pro2_8_2070_wUHV.mat','B22_utilize_trans_storage_IX2'); % USD2019/kWh
...
% % carbon neutrality
% 
B_utilize_trans_storage_fenzi = (sum(lcoeeall_utilize_trans_storage(:,1:11),2)+Cost_storage-phhall_utilize_trans_storage(:,1).*EP*10^3);
B_utilize_trans_storage_fenmu = (-CO2_all_utilize_trans_storage); %USD/t CO2
B_utilize_trans_storage_Sto_fenzi = Cost_storage; %USD/t CO2
save('H:\global-PV-wind\ANS\B_mecha_county_all_pro2_8_2070_wUHV_fenzi.mat','B_utilize_trans_storage_fenzi'); % USD2019/kWh
save('H:\global-PV-wind\ANS\B_mecha_county_all_pro2_8_2070_wUHV_fenmu.mat','B_utilize_trans_storage_fenmu'); % USD2019/kWh
