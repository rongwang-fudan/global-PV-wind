    ...
    if country2==-1 % 没有UHV station
        ...
        for zz = 1:288
            ...
            if id_cou(country,zz)==1 && id_cou(country,289)==0
                ...
                etrans_cou_num(i,country,country) = etrans_cou_num(i,country,country)+P_ef1/ef1/ef2/ef3(cho(i));
...
save('H:\Global PV and wind\ANS\etrans_cou1_num_1023_pro2_testt_UHV_sto_8_2070.mat','etrans_cou1_num1','-v7.3')% 实际有效发电量, TWh/year
save('H:\Global PV and wind\ANS\etrans_cou_num_1023_pro2_testt_UHV_sto_8_2070.mat','etrans_cou_num1','-v7.3')% 全部发电量, TWh/year
                        ...
                        if powergenerat_monhour(zz,i)>0
                            ...
                            if dis2<=10000 && id_cou(cou2,289)==0 && id_cou(cou2,zz)==0
                                ...
                                if P_ef1*10^6>=1
                                    ...
                                    etrans_REG(REG,REG2) = etrans_REG(REG,REG2) + P_ef1/ef1/ef2;
                                    etrans_REG_type(REG,REG2,type(i,1)) = etrans_REG_type(REG,REG2,type(i,1)) + P_ef1/ef1/ef2;
                                    etrans_cou_num(i,country,cou2) = etrans_cou_num(i,country,cou2)+P_ef1/ef1/ef2;
                                    ...
                                    etrans_REG1(REG,REG2) = etrans_REG1(REG,REG2) + P_ef1;
                                    etrans_REG_type1(REG,REG2,type(i,1)) = etrans_REG_type1(REG,REG2,type(i,1)) + P_ef1;
                                    etrans_cou1_num(i,country,cou2) = etrans_cou1_num(i,country,cou2)+P_ef1;
                                    end
                                end
                            end
                        end
                        ...
                        if powergenerat_monhour(zz,i)>0
                            ...
                            if dis2<=10000 && id_cou(cou2,289)==0 && id_cou(cou2,zz)==1
                                ...
                                if P_ef1*10^6>=1
                                    ...
                                    etrans_cou_num(i,country,cou2) = etrans_cou_num(i,country,cou2)+P_ef1/ef1/ef2/ef3(cho(i))/ef4;
...
etrans_cou1_num = etrans_cou1_num/288*8760; % 实际有效发电量, TWh/year
etrans_cou_num = etrans_cou_num/288*8760; % 全部发电量, TWh/year

save('H:\Global PV and wind\ANS\id_cou_1023_pro2_testt_UHV_sto_interUHV_8_2070.mat','id_cou','-v7.3')% 289列若为1，则满足
save('H:\Global PV and wind\ANS\etrans_cou1_num_1023_pro2_testt_UHV_sto_interUHV_8_2070.mat','etrans_cou1_num','-v7.3')% 实际有效发电量, TWh/year
save('H:\Global PV and wind\ANS\etrans_cou_num_1023_pro2_testt_UHV_sto_interUHV_8_2070.mat','etrans_cou_num','-v7.3')% 全部发电量, TWh/year
