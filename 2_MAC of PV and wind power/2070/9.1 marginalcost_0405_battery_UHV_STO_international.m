...
load('H:\global-PV-wind\ANS\utilize_ratio2060_UHV_storage_inter_county_all_pro.mat')  % power use efficiency with global electric transport and storage
...
load('H:\global-PV-wind\ANS\storage_max_plant_UHV_storage_inter_county_all_pro.mat')   % Maximum charging power, TWh/h  
load('H:\global-PV-wind\ANS\storage_year_plant_UHV_storage_inter_county_all_pro.mat')  % Average annual electricity storage, TWh/year
...
%
% load('H:\global-PV-wind\ANS\optimized_Time\unitmin_global_IX.mat');
% unitmin(unitmin==0)=[];
...
% rIe=[180.60,114.13,100.02,85.79]./180.60;
% rIe=[345,198, 174, 149]./345;
% rIp=[595.73,450,374.45,351,327.22,304,280.78, 257.56]./595.73;
% rIe=[345,240,198,186,174,161,149,138]./345;
...
% save('H:\global-PV-wind\ANS\degrat40yr_PV_p%_LRglobal_inilow_pv_8_2070.mat','degrat40yr_PV_p'); % TWh/year
% save('H:\global-PV-wind\ANS\degrat40yr_PV_p%degrat40yr_onshorewind_p_8_2070.mat','degrat40yr_onshorewind_p'); % TWh/year
% save('H:\global-PV-wind\ANS\degrat40yr_PV_p%degrat40yr_offshorewind_p_8_2070.mat','degrat40yr_offshorewind_p'); % TWh/year
% for t=1:30
...
save('H:\global-PV-wind\ANS\LCOEE_Battery_county_all_pro_8_2070.mat','LCOEE_all_utilize_trans_storage', '-v7.3')  % billion kWh / year
...
save('H:\global-PV-wind\ANS\CP_UHV_STO_INT_pro_8_2070.mat','CP', '-v7.3')  % billion kWh / year
save('H:\global-PV-wind\ANS\CO2_UHV_STO_INT_pro_8_2070.mat','CO2all_c_utilize_trans_storage', '-v7.3')  % billion kWh / year
save('H:\global-PV-wind\ANS\B_UHV_STO_INT_pro_8_2070.mat','B_utilize_trans_storage', '-v7.3')  % billion kWh / year
...
%%
save('H:\global-PV-wind\ANS\CO2_Battery_county_all_pro_8_2070.mat','CO2all_c_utilize_trans_storage'); % USD2019/kWh
save('H:\global-PV-wind\ANS\B_Battery_county_all_pro_8_2070.mat','B_utilize_trans_storage'); % USD2019/kWh
...
save('H:\global-PV-wind\ANS\CO2_Battery_ix_county_all_pro_8_2070.mat','CO2all2_c22_utilize_trans_storage_IX2'); % USD2019/kWh
save('H:\global-PV-wind\ANS\B_Battery_ix_county_all_pro_8_2070.mat','B22_utilize_trans_storage_IX2'); % USD2019/kWh
