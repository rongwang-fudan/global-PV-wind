...
% load('H:\global-PV-wind\ANS\cost_trans_IX_battery_mechanical_all_pro2_8_2070_nointerUHV_nodomSto.mat')% million $和optpowerunit_IX顺序一样
% load('H:\global-PV-wind\ANS\CP_trans_IX_battery_mechanical_all_pro2_8_2070_nointerUHV_nodomSto.mat')% MW
...
% load('H:\global-PV-wind\ANS\utilize_ratio2060_UHV_storage_inter_county_battery_mechanical_all_pro2_8_2070_nointerUHV_nodomSto.mat')  % power use efficiency with global electric transport and storage
...
% load('H:\global-PV-wind\ANS\storage_max_plant_UHV_storage_inter_county_battery_mechanical_all_pro2_8_2070_nointerUHV_nodomSto.mat')   % Maximum charging power, TWh/h  
% load('H:\global-PV-wind\ANS\storage_year_plant_UHV_storage_inter_county_battery_mechanical_all_pro2_8_2070_nointerUHV_nodomSto.mat')  % Average annual electricity storage, TWh/year
...
save('H:\global-PV-wind\ANS\emissionfactor_8_2070_testt_UHV.mat','emissionfactor', '-v7.3')  
clear ixx_2_1
...
save('H:\global-PV-wind\ANS\LCOE_UHV_STO_INT_county_all_withUHVcost_pro2_8_2070_testt_UHV.mat','LCOEE_all_utilize_trans_storage', '-v7.3')  % billion kWh / year
