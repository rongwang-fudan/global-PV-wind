...
%     end
    time
    filename = strcat('H:\global-PV-wind\ANS\learnprice_region_county0811_all_2_pro',num2str(time+1),'_8_2070.mat');
    save(filename, 'learnprice_region','-v7.3');
end
