...
% load('H:\global-PV-wind\ANS\utilize_ratio2060_UHV_storage.mat')  % power use efficiency with inter-regional electric transport and storage
% utilize_ratio2060 =utilize_ratio2060_UHV_storage;
% clear utilize_ratio2060_UHV_storage

% load('H:\global-PV-wind\ANS\utilize_ratio2060_UHV_storage_reg.mat')  % power use efficiency with inter-regional electric transport and storage
% utilize_ratio2060 =utilize_ratio2060_UHV_storage_reg;
% clear utilize_ratio2060_UHV_storage_reg

load('H:\global-PV-wind\ANS\utilize_ratio2060_UHV_storage_inter_county_all_pro2_8_2070.mat')  % power use efficiency with global electric transport and storage
...
load('H:\global-PV-wind\ANS\storage_max_plant_UHV_storage_inter_county_all_pro2_8_2070.mat')   % Maximum charging power, TWh/h  
load('H:\global-PV-wind\ANS\storage_year_plant_UHV_storage_inter_county_all_pro2_8_2070.mat')  % Average annual electricity storage, TWh/year
...
%
% load('H:\global-PV-wind\ANS\unitmin_global_IX.mat');
% unitmin(unitmin==0)=[];
...
% save('H:\global-PV-wind\ANS\degrat40yr_PV_p%_LRglobal_inilow_pv2_8_2070.mat','degrat40yr_PV_p'); % TWh/year
% save('H:\global-PV-wind\ANS\degrat40yr_PV_p%degrat40yr_onshorewind_p2_8_2070.mat','degrat40yr_onshorewind_p'); % TWh/year
% save('H:\global-PV-wind\ANS\degrat40yr_PV_p%degrat40yr_offshorewind_p2_8_2070.mat','degrat40yr_offshorewind_p'); % TWh/year
% for t=1:30
...
save('H:\global-PV-wind\ANS\LCOEE_Battery_county_all_pro2_8_2070.mat','LCOEE_all_utilize_trans_storage', '-v7.3')  % billion kWh / year
...
save('H:\global-PV-wind\ANS\EP_8_2070_xz_battery.mat','EP'); 
save('H:\global-PV-wind\ANS\emissionfactor_8_2070_xz_battery.mat','emissionfactor'); 
clear ixx_2_1
...
% save('H:\global-PV-wind\ANS\LCOE_UHV_STO_INT2_8_2070.mat','LCOEE_all_utilize_trans_storage', '-v7.3')  % billion kWh / year
phhall_utilize_trans_storage111 = phhall_utilize_trans_storage(:,1);
% save('H:\global-PV-wind\ANS\Ph_UHV_STO_reg2_8_2070.mat','phhall_utilize_trans_storage111', '-v7.3')  % billion kWh / year
cost = sum(lcoeeall_utilize_trans_storage(:,1:9),2)+Cost_storage;
% save('H:\global-PV-wind\ANS\costtt_UHV_STO_reg2_8_2070.mat','cost', '-v7.3')  % 
...
save('H:\global-PV-wind\ANS\CP_UHV_STO_INT_pro2_8_2070.mat','CP', '-v7.3')  % billion kWh / year
save('H:\global-PV-wind\ANS\CO2_UHV_STO_INT_pro2_8_2070.mat','CO2all_c_utilize_trans_storage', '-v7.3')  % billion kWh / year
save('H:\global-PV-wind\ANS\B_UHV_STO_INT_pro2_8_2070.mat','B_utilize_trans_storage', '-v7.3')  % billion kWh / year
% save('H:\global-PV-wind\ANS\CO2_PV_year_STO_INT2_8_2070.mat','CO2_PV_year', '-v7.3')  % billion kWh / year
% save('H:\global-PV-wind\ANS\CO2_onshorewind_year_STO_INT2_8_2070.mat','CO2_onshorewind_year', '-v7.3')  % billion kWh / year
% save('H:\global-PV-wind\ANS\CO2_offshorewind_year_STO_INT2_8_2070.mat','CO2_offshorewind_year', '-v7.3')  % billion kWh / year

% save('H:\global-PV-wind\ANS\CP_UHV_STO_reg2_8_2070.mat','CP', '-v7.3')  % billion kWh / year
% save('H:\global-PV-wind\ANS\CO2_UHV_STO_reg2_8_2070.mat','CO2all_c_utilize_trans_storage', '-v7.3')  % billion kWh / year
% save('H:\global-PV-wind\ANS\B_UHV_STO_reg2_8_2070.mat','B_utilize_trans_storage', '-v7.3')  % billion kWh / year
% save('H:\global-PV-wind\ANS\CP_UHV_STO2_8_2070.mat','CP', '-v7.3')  % billion kWh / year
% save('H:\global-PV-wind\ANS\CO2_UHV_STO2_8_2070.mat','CO2all_c_utilize_trans_storage', '-v7.3')  % billion kWh / year
% save('H:\global-PV-wind\ANS\B_UHV_STO2_8_2070.mat','B_utilize_trans_storage', '-v7.3')  % billion kWh / year

% % save('H:\global-PV-wind\ANS\CO2_UHV_STO_INT_pv2_8_2070.mat','CO2all_c_utilize_trans_storage_pv', '-v7.3')  % billion kWh / year
% % save('H:\global-PV-wind\ANS\B_UHV_STO_INT_pv2_8_2070.mat','B_utilize_trans_storage_pv', '-v7.3')  % billion kWh / year
% % 
% % save('H:\global-PV-wind\ANS\CO2_UHV_STO_INT_ons2_8_2070.mat','CO2all_c_utilize_trans_storage_onshorewind', '-v7.3')  % billion kWh / year
% % save('H:\global-PV-wind\ANS\B_UHV_STO_INT_ons2_8_2070.mat','B_utilize_trans_storage_onshorewind', '-v7.3')  % billion kWh / year
% % 
% % save('H:\global-PV-wind\ANS\CO2_UHV_STO_INT_off2_8_2070.mat','CO2all_c_utilize_trans_storage_offshorewind', '-v7.3')  % billion kWh / year
% % save('H:\global-PV-wind\ANS\B_UHV_STO_INT_off2_8_2070.mat','B_utilize_trans_storage_offshorewind', '-v7.3')  % billion kWh / year

[B_utilize_trans_storage_IX,IX]=sort(B_utilize_trans_storage);
% save('H:\global-PV-wind\ANS\IX_UHV_STO_INT2_8_2070.mat','IX', '-v7.3')  % 
...
%%
save('H:\global-PV-wind\ANS\CO2_Battery_county_all_pro2_8_2070.mat','CO2all_c_utilize_trans_storage'); % USD2019/kWh
save('H:\global-PV-wind\ANS\B_Battery_county_all_pro2_8_2070.mat','B_utilize_trans_storage'); % USD2019/kWh
save('H:\global-PV-wind\ANS\B_sto_Battery_county_all_pro2_8_2070.mat','B_utilize_trans_storage_Sto', '-v7.3')  % billion kWh / year
...
save('H:\global-PV-wind\ANS\CO2_Battery_ix_county_all_pro2_8_2070.mat','CO2all2_c22_utilize_trans_storage_IX2'); % USD2019/kWh
save('H:\global-PV-wind\ANS\B_Battery_ix_county_all_pro2_8_2070.mat','B22_utilize_trans_storage_IX2'); % USD2019/kWh
