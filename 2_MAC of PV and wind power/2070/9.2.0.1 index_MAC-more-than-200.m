tic
clear;
load('H:\Global PV and wind\ANS\utilize_ratio2060_UHV_storage_inter_county_battery_mechanical_all_pro_8_2070.mat')  % power use efficiency with global electric transport and storage
...
m_cho(m2,1) = 5;
save('H:\Global PV and wind\ANS\m_cho_8_2070.mat','m_cho'); % 


%%
tic
clear;
load('H:\Global PV and wind\ANS\m_cho_8_2070.mat'); % m_cho
save('H:\Global PV and wind\ANS\m_cho2_8_2070.mat','m_cho'); % 
...
load('H:\Global PV and wind\ANS\m_cho2_8_2070.mat'); % m_cho
[m,n]=find(m_cho==0);
optpowerunit_IX(m,:)=[];
...
save('H:\Global PV and wind\ANS\index_mineral_pv_county0811_2_all_CNfirst_5%_inilow_pro2_8_2070.mat','index_mineral_pv') % 按照成本排序后保留的PV电厂原始序号
save('H:\Global PV and wind\ANS\index_mineral_ons_county0811_2_all_CNfirst_5%_inilow_pro2_8_2070.mat','index_mineral_ons') % 按照成本排序后保留的onshorewind电厂原始序号
save('H:\Global PV and wind\ANS\index_mineral_off_county0811_2_all_CNfirst_5%_inilow_pro2_8_2070.mat','index_mineral_off') % 按照成本排序后保留的offshorewind电厂原始序号
