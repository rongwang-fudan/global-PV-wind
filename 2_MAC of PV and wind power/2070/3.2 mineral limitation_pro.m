...
%%
load('H:\Global PV and wind\ANS\mineral_production_pro.mat');  %  thousand metric tons/year
load('H:\Global PV and wind\ANS\mineral_reserve_pro.mat');  %  thousand metric tons
...
save('H:\Global PV and wind\ANS\m_mineral_county0811_2_all_CNfirst_5%_inilow_pro.mat','m_mineral')
...
save('H:\Global PV and wind\ANS\index_mineral_pv_county0811_2_all_CNfirst_5%_inilow_pro.mat','index_mineral_pv') % 按照成本排序后保留的PV电厂原始序号
save('H:\Global PV and wind\ANS\index_mineral_ons_county0811_2_all_CNfirst_5%_inilow_pro.mat','index_mineral_ons') % 按照成本排序后保留的onshorewind电厂原始序号
save('H:\Global PV and wind\ANS\index_mineral_off_county0811_2_all_CNfirst_5%_inilow_pro.mat','index_mineral_off') % 按照成本排序后保留的offshorewind电厂原始序号
