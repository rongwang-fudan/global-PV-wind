                            ...
                            for p5=peneminA(2,1)-p1-p2-p3-p4:1:peneminA(3,1)-p1-p2-p3-p4
                                ...
                                for p6=peneminA(3,1)-p1-p2-p3-p4-p5
                                    ...
                                    for p7=peneminA(3,1)-p1-p2-p3-p4-p5-p6:1:peneminA(4,1)-p1-p2-p3-p4-p5-p6
                                        pene(7,1)=(p1+p2+p3+p4+p5+p6+p7)/100; % 
...
save('H:\Global PV and wind\ANS\3power_country_region_county0811_all_country_5%_LRglobal_inilow_pv_pro2070.mat','power_country');
save('H:\Global PV and wind\ANS\3unit_PV_region_county0811_all_country_5%_LRglobal_inilow_pv_pro2070.mat','unit_PV_global');
save('H:\Global PV and wind\ANS\learnprice_region_county0811_all_country_5%_LRglobal_inilow_pv_pro2070.mat','learnprice_region'); 
save('H:\Global PV and wind\ANS\numpowerunit_pv_pro2070.mat','numpowerunit_pv'); 
save('H:\Global PV and wind\ANS\cost_all2020_cou_pv_pro2070.mat','cost_all2020_cou');
save('H:\Global PV and wind\ANS\cost_ave_cou_pv_pro2070.mat','cost_ave_cou'); 
save('H:\Global PV and wind\ANS\costmin_cou_pv_pro2070.mat','costmin_cou'); 
