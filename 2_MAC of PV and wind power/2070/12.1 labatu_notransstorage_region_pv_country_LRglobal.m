...
tic
clear;
load('H:\world\data\r_module_hardwarecost_pv.mat');
...
% load('H:\global-PV-wind\ANS\powerdemand_monhour2060_ele_1023_2.mat')  %  TWh/h
...
%                                 end
        ...
        if size(optpowerunit_IX,1)==1
            unitmin=ones(10,1);
%             filename = strcat('H:\global-PV-wind\ANS\optimized_Time\3unitmin_region',num2str(country),'_county0811_all_pv_pro.mat');
...
save('H:\global-PV-wind\ANS\3power_country_region_county0811_all_country_5%_LRglobal_inilow_pv_pro20702_8_2070.mat','power_country'); % TWh/year
save('H:\global-PV-wind\ANS\3unit_PV_region_county0811_all_country_5%_LRglobal_inilow_pv_pro20702_8_2070.mat','unit_PV_global');
save('H:\global-PV-wind\ANS\learnprice_region_county0811_all_country_5%_LRglobal_inilow_pv_pro20702_8_2070.mat','learnprice_region'); % 10 regions * 6
save('H:\global-PV-wind\ANS\numpowerunit_pv_pro20702_8_2070.mat','numpowerunit_pv'); % numpowerunit_pv,各国PV电厂个数
save('H:\global-PV-wind\ANS\cost_all2020_cou_pv_pro20702_8_2070.mat','cost_all2020_cou');
save('H:\global-PV-wind\ANS\cost_ave_cou_pv_pro20702_8_2070.mat','cost_ave_cou'); %
save('H:\global-PV-wind\ANS\costmin_cou_pv_pro20702_8_2070.mat','costmin_cou'); %
