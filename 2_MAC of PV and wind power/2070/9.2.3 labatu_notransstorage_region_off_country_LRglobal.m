...
% load('H:\world\code\index_mineral_pv_county0811_2_all.mat') % 按照成本排序后保留的PV电厂原始序号
% load('H:\world\code\index_mineral_ons_county0811_2_all.mat') % 按照成本排序后保留的onshorewind电厂原始序号
% load('H:\world\code\index_mineral_off_county0811_2_all.mat') % 按照成本排序后保留的offshorewind电厂原始序号
...
%                                     unit2(yy,1)=idx(1);
                                    if unit2(yy,1)>=unit1 && unit2(yy,1)~=1
                                        if unit1==1
                                            ...
                                            % offshorewind
                                            % 1  module cost
                                            aa= initialcost_ratio_country(country).*module_price_offshore.*(CP0_offshorewind_cum(unit2(yy,1),1)-CP0_offshorewind_cum(unit1-1,1))*learnprice_offshorewind(unit1); % cost million USD
                                            % 2  others
                                            aa2= ((cost_offshorewind(unit2(yy,1),6)-cost_offshorewind(unit1-1,6))- initialcost_ratio_country(country).*module_price_offshore.*(CP0_offshorewind_cum(unit2(yy,1),1)-CP0_offshorewind_cum(unit1-1,1)))*learnprice_offshorewind_2(unit1); % cost million USD
                                            % 9  O&M cost
...
%             filename = strcat('H:\Global PV and wind\ANS\optimized_Time\3unitmin_region',num2str(country),'_county0811_all_off_pro.mat');
...
save('H:\Global PV and wind\ANS\3power_country_region_county0811_all_country_5%_LRglobal_inilow_off_pro20702_8_2070.mat','power_country'); % TWh/year
save('H:\Global PV and wind\ANS\3unit_offshorewind_region_county0811_all_country_5%_LRglobal_inilow_off_pro20702_8_2070.mat','unit_offshorewind_global');
save('H:\Global PV and wind\ANS\learnprice_region_county0811_all_country_5%_LRglobal_inilow_off_pro20702_8_2070.mat','learnprice_region'); % 10 regions * 6
save('H:\Global PV and wind\ANS\cost_all2020_cou_off_pro20702_8_2070.mat','cost_all2020_cou');
save('H:\Global PV and wind\ANS\cost_ave_cou_off_pro20702_8_2070.mat','cost_ave_cou'); % 10 regions * 6
save('H:\Global PV and wind\ANS\costmin_cou_off_pro20702_8_2070.mat','costmin_cou'); %
