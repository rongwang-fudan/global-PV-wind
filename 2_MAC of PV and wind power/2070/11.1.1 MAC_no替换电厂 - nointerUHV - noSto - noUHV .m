...
save('H:\Global PV and wind\ANS\emissionfactor_8_2070_testtxz.mat','emissionfactor', '-v7.3')  
clear ixx_2_1
...
save('H:\Global PV and wind\ANS\LCOE_UHV_STO_INT_county_all_withUHVcost_pro2_8_2070_testtxz.mat','LCOEE_all_utilize_trans_storage', '-v7.3')  % billion kWh / year
