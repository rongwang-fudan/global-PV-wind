tic
clear;
load('H:\global-PV-wind\ANS\LCOE_UHV_STO_INT_county_all_withUHVcost_pro2_8_2040_testt_UHV_sto_interUHV.mat')  % 
LCOEE(:,8) = LCOEE_all_utilize_trans_storage;
load('H:\global-PV-wind\ANS\LCOE_UHV_STO_INT_county_all_withUHVcost_pro2_8_2040_testt_UHV_sto.mat')  % 
LCOEE(:,7) = LCOEE_all_utilize_trans_storage;
load('H:\global-PV-wind\ANS\LCOE_UHV_STO_INT_county_all_withUHVcost_pro2_8_2040_testt_sto_interUHV.mat')  % 
LCOEE(:,6) = LCOEE_all_utilize_trans_storage;
load('H:\global-PV-wind\ANS\LCOE_UHV_STO_INT_county_all_withUHVcost_pro2_8_2040_testt_UHV_interUHV.mat')  % 
LCOEE(:,5) = LCOEE_all_utilize_trans_storage;
load('H:\global-PV-wind\ANS\LCOE_UHV_STO_INT_county_all_withUHVcost_pro2_8_2040_testt_UHV.mat')  % 
LCOEE(:,4) = LCOEE_all_utilize_trans_storage;
load('H:\global-PV-wind\ANS\LCOE_UHV_STO_INT_county_all_withUHVcost_pro2_8_2040_testt_sto.mat')  % 
LCOEE(:,3) = LCOEE_all_utilize_trans_storage;
load('H:\global-PV-wind\ANS\LCOE_UHV_STO_INT_county_all_withUHVcost_pro2_8_2040_testt_interUHV.mat')  % 
LCOEE(:,2) = LCOEE_all_utilize_trans_storage;
load('H:\global-PV-wind\ANS\LCOE_UHV_STO_INT_county_all_withUHVcost_pro2_8_2040_testt.mat')  % 
...
save('H:\global-PV-wind\ANS\choo_type_8_2040.mat','choo'); 
...
load('H:\global-PV-wind\ANS\choo_type_8_2040.mat'); % choo
for i = 1:8
    [m,n]=find(choo==i);
...
save('H:\global-PV-wind\ANS\utilize_ratio_8_2040_xz.mat','utilize_ratio2060_UHV_storage_inter'); 
save('H:\global-PV-wind\ANS\cost_trans_8_2040_xz.mat','cost_trans_IX'); 
save('H:\global-PV-wind\ANS\CP_trans_8_2040_xz.mat','CP_trans_IX'); 
save('H:\global-PV-wind\ANS\storage_max_plant_8_2040_xz.mat','storage_max_plant_UHV_storage_inter'); 
save('H:\global-PV-wind\ANS\storage_year_plant_8_2040_xz.mat','storage_inter_year_plant_UHV_storage'); 
