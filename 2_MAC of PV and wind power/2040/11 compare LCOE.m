tic
clear;
load('H:\global-PV-wind\ANS\LCOE_UHV_STO_INT_county_all_withUHVcost_pro2_8_2040_testt_UHV_sto_interUHVxz.mat')  % 
LCOEE(:,8) = LCOEE_all_utilize_trans_storage;
load('H:\global-PV-wind\ANS\LCOE_UHV_STO_INT_county_all_withUHVcost_pro2_8_2040_testt_UHV_stoxz.mat')  % 
LCOEE(:,7) = LCOEE_all_utilize_trans_storage;
load('H:\global-PV-wind\ANS\LCOE_UHV_STO_INT_county_all_withUHVcost_pro2_8_2040_testt_sto_interUHVxz.mat')  % 
LCOEE(:,6) = LCOEE_all_utilize_trans_storage;
load('H:\global-PV-wind\ANS\LCOE_UHV_STO_INT_county_all_withUHVcost_pro2_8_2040_testt_UHV_interUHVxz.mat')  % 
LCOEE(:,5) = LCOEE_all_utilize_trans_storage;
load('H:\global-PV-wind\ANS\LCOE_UHV_STO_INT_county_all_withUHVcost_pro2_8_2040_testt_UHVxz.mat')  % 
LCOEE(:,4) = LCOEE_all_utilize_trans_storage;
load('H:\global-PV-wind\ANS\LCOE_UHV_STO_INT_county_all_withUHVcost_pro2_8_2040_testt_stoxz.mat')  % 
LCOEE(:,3) = LCOEE_all_utilize_trans_storage;
load('H:\global-PV-wind\ANS\LCOE_UHV_STO_INT_county_all_withUHVcost_pro2_8_2040_testt_interUHVxz.mat')  % 
LCOEE(:,2) = LCOEE_all_utilize_trans_storage;
load('H:\global-PV-wind\ANS\LCOE_UHV_STO_INT_county_all_withUHVcost_pro2_8_2040_testtxz.mat')  % 
...
save('H:\global-PV-wind\ANS\choo_type_8_2040xz.mat','choo'); 
...
save('H:\global-PV-wind\ANS\utilize_ratio_8_2040_xzxz.mat','utilize_ratio2060_UHV_storage_inter'); 
save('H:\global-PV-wind\ANS\cost_trans_8_2040_xzxz.mat','cost_trans_IX'); 
save('H:\global-PV-wind\ANS\CP_trans_8_2040_xzxz.mat','CP_trans_IX'); 
save('H:\global-PV-wind\ANS\storage_max_plant_8_2040_xzxz.mat','storage_max_plant_UHV_storage_inter'); 
save('H:\global-PV-wind\ANS\storage_year_plant_8_2040_xzxz.mat','storage_inter_year_plant_UHV_storage'); 
...
save('H:\global-PV-wind\ANS\cho_county_all_pro2_8_2070_xz_2040C.mat','cho'); %
% 0是无需储能，1是机械储能，-1是化学储能
