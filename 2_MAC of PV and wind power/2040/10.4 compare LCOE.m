tic
clear;
load('H:\Global PV and wind\ANS\LCOE_UHV_STO_INT_county_all_withUHVcost_pro2_8_2040_testt_UHV_sto_interUHVxz.mat')  % 
LCOEE(:,4) = LCOEE_all_utilize_trans_storage;
load('H:\Global PV and wind\ANS\LCOE_UHV_STO_INT_county_all_withUHVcost_pro2_8_2040_testt_UHV_stoxz.mat')  % 
...
save('H:\Global PV and wind\ANS\choo_type_8_2040xz.mat','choo'); 
...
save('H:\Global PV and wind\ANS\utilize_ratio_8_2040_xzxz.mat','utilize_ratio2060_UHV_storage_inter'); 
save('H:\Global PV and wind\ANS\cost_trans_8_2040_xzxz.mat','cost_trans_IX'); 
save('H:\Global PV and wind\ANS\CP_trans_8_2040_xzxz.mat','CP_trans_IX'); 
save('H:\Global PV and wind\ANS\storage_max_plant_8_2040_xzxz.mat','storage_max_plant_UHV_storage_inter'); 
save('H:\Global PV and wind\ANS\storage_year_plant_8_2040_xzxz.mat','storage_inter_year_plant_UHV_storage'); 
