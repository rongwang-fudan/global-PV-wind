    ...
    if ~isempty(m22)
        ...
        if ~isempty(optpowerunit)
            ...
            if size(optpowerunit_IX,1)>1
                ...
                %             filename = strcat('H:\Global PV and wind\ANS\3unitmin_region',num2str(country),'_county0811_all_off_pro.mat');
...
save('H:\Global PV and wind\ANS\unit_offshorewind_global_2040.mat','unit_offshorewind_global');
