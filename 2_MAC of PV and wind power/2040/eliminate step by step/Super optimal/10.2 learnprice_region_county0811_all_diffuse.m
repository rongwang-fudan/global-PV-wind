...
for time = 1:1:10
    ...
    for i = 1:6
        [m2,n2]=find(learnprice_region(:,i)==min(learnprice_region(:,i)));
        learn_country(time+1,i) = m2;
        [m,n]=find(learnprice_region(:,i)>min(learnprice_region(:,i)));
        learnprice_region(m,i) = min(learnprice_region(:,i));
        learnprice_region2(time+1,i) = min(learnprice_region(:,i));
    end
    ...
    filename = strcat('H:\Global PV and wind\ANS\learnprice_region_county0811_all_2_pro',num2str(time+1),'2_192_2040_8xzsuper.mat');
    save(filename, 'learnprice_region_d192','-v7.3');
    time
end
save('H:\Global PV and wind\ANS\index_cou_2040xzsuper.mat','learn_country'); % (time+1,i)
clear learnprice_region
% save('H:\Global PV and wind\ANS\learn_country_diffuse_8_2040xz.mat','learn_country'); % 10 regions * 6
...
% learnprice_region = ones(192,6);
learnprice_region(:,1) = learnprice_region1(2,1)./initialcost_ratio_country(:,1);
learnprice_region(:,2) = learnprice_region1(2,2)./initialcost_ratio_country(:,1);
learnprice_region(:,3) = learnprice_region1(2,3)./initialcost_ratio_country(:,2);
learnprice_region(:,4) = learnprice_region1(2,4)./initialcost_ratio_country(:,2);
learnprice_region(:,5) = learnprice_region1(2,5)./initialcost_ratio_country(:,3);
learnprice_region(:,6) = learnprice_region1(2,6)./initialcost_ratio_country(:,3);
save('H:\Global PV and wind\ANS\learnprice_region_county0811_all_2_diffuse_pro22_8_2040xzsuper.mat','learnprice_region'); % 10 regions * 6

learnprice_region(:,1) = learnprice_region1(3,1)./initialcost_ratio_country(:,1);
learnprice_region(:,2) = learnprice_region1(3,2)./initialcost_ratio_country(:,1);
learnprice_region(:,3) = learnprice_region1(3,3)./initialcost_ratio_country(:,2);
learnprice_region(:,4) = learnprice_region1(3,4)./initialcost_ratio_country(:,2);
learnprice_region(:,5) = learnprice_region1(3,5)./initialcost_ratio_country(:,3);
learnprice_region(:,6) = learnprice_region1(3,6)./initialcost_ratio_country(:,3);
save('H:\Global PV and wind\ANS\learnprice_region_county0811_all_2_diffuse_pro32_8_2040xzsuper.mat','learnprice_region'); %

learnprice_region(:,1) = learnprice_region1(4,1)./initialcost_ratio_country(:,1);
learnprice_region(:,2) = learnprice_region1(4,2)./initialcost_ratio_country(:,1);
learnprice_region(:,3) = learnprice_region1(4,3)./initialcost_ratio_country(:,2);
learnprice_region(:,4) = learnprice_region1(4,4)./initialcost_ratio_country(:,2);
learnprice_region(:,5) = learnprice_region1(4,5)./initialcost_ratio_country(:,3);
learnprice_region(:,6) = learnprice_region1(4,6)./initialcost_ratio_country(:,3);
save('H:\Global PV and wind\ANS\learnprice_region_county0811_all_2_diffuse_pro42_8_2040xzsuper.mat','learnprice_region'); %

learnprice_region(:,1) = learnprice_region1(5,1)./initialcost_ratio_country(:,1);
learnprice_region(:,2) = learnprice_region1(5,2)./initialcost_ratio_country(:,1);
learnprice_region(:,3) = learnprice_region1(5,3)./initialcost_ratio_country(:,2);
learnprice_region(:,4) = learnprice_region1(5,4)./initialcost_ratio_country(:,2);
learnprice_region(:,5) = learnprice_region1(5,5)./initialcost_ratio_country(:,3);
learnprice_region(:,6) = learnprice_region1(5,6)./initialcost_ratio_country(:,3);
save('H:\Global PV and wind\ANS\learnprice_region_county0811_all_2_diffuse_pro52_8_2040xzsuper.mat','learnprice_region'); %

learnprice_region(:,1) = learnprice_region1(6,1)./initialcost_ratio_country(:,1);
learnprice_region(:,2) = learnprice_region1(6,2)./initialcost_ratio_country(:,1);
learnprice_region(:,3) = learnprice_region1(6,3)./initialcost_ratio_country(:,2);
learnprice_region(:,4) = learnprice_region1(6,4)./initialcost_ratio_country(:,2);
learnprice_region(:,5) = learnprice_region1(6,5)./initialcost_ratio_country(:,3);
learnprice_region(:,6) = learnprice_region1(6,6)./initialcost_ratio_country(:,3);
save('H:\Global PV and wind\ANS\learnprice_region_county0811_all_2_diffuse_pro62_8_2040xzsuper.mat','learnprice_region'); %

learnprice_region(:,1) = learnprice_region1(7,1)./initialcost_ratio_country(:,1);
learnprice_region(:,2) = learnprice_region1(7,2)./initialcost_ratio_country(:,1);
learnprice_region(:,3) = learnprice_region1(7,3)./initialcost_ratio_country(:,2);
learnprice_region(:,4) = learnprice_region1(7,4)./initialcost_ratio_country(:,2);
learnprice_region(:,5) = learnprice_region1(7,5)./initialcost_ratio_country(:,3);
learnprice_region(:,6) = learnprice_region1(7,6)./initialcost_ratio_country(:,3);
save('H:\Global PV and wind\ANS\learnprice_region_county0811_all_2_diffuse_pro72_8_2040xzsuper.mat','learnprice_region'); %

learnprice_region(:,1) = learnprice_region1(8,1)./initialcost_ratio_country(:,1);
learnprice_region(:,2) = learnprice_region1(8,2)./initialcost_ratio_country(:,1);
learnprice_region(:,3) = learnprice_region1(8,3)./initialcost_ratio_country(:,2);
learnprice_region(:,4) = learnprice_region1(8,4)./initialcost_ratio_country(:,2);
learnprice_region(:,5) = learnprice_region1(8,5)./initialcost_ratio_country(:,3);
learnprice_region(:,6) = learnprice_region1(8,6)./initialcost_ratio_country(:,3);
save('H:\Global PV and wind\ANS\learnprice_region_county0811_all_2_diffuse_pro82_8_2040xzsuper.mat','learnprice_region'); %

learnprice_region(:,1) = learnprice_region1(9,1)./initialcost_ratio_country(:,1);
learnprice_region(:,2) = learnprice_region1(9,2)./initialcost_ratio_country(:,1);
learnprice_region(:,3) = learnprice_region1(9,3)./initialcost_ratio_country(:,2);
learnprice_region(:,4) = learnprice_region1(9,4)./initialcost_ratio_country(:,2);
learnprice_region(:,5) = learnprice_region1(9,5)./initialcost_ratio_country(:,3);
learnprice_region(:,6) = learnprice_region1(9,6)./initialcost_ratio_country(:,3);
save('H:\Global PV and wind\ANS\learnprice_region_county0811_all_2_diffuse_pro92_8_2040xzsuper.mat','learnprice_region'); %

learnprice_region(:,1) = learnprice_region1(10,1)./initialcost_ratio_country(:,1);
learnprice_region(:,2) = learnprice_region1(10,2)./initialcost_ratio_country(:,1);
learnprice_region(:,3) = learnprice_region1(10,3)./initialcost_ratio_country(:,2);
learnprice_region(:,4) = learnprice_region1(10,4)./initialcost_ratio_country(:,2);
learnprice_region(:,5) = learnprice_region1(10,5)./initialcost_ratio_country(:,3);
learnprice_region(:,6) = learnprice_region1(10,6)./initialcost_ratio_country(:,3);
save('H:\Global PV and wind\ANS\learnprice_region_county0811_all_2_diffuse_pro102_8_2040xzsuper.mat','learnprice_region'); %

learnprice_region(:,1) = learnprice_region1(11,1)./initialcost_ratio_country(:,1);
learnprice_region(:,2) = learnprice_region1(11,2)./initialcost_ratio_country(:,1);
learnprice_region(:,3) = learnprice_region1(11,3)./initialcost_ratio_country(:,2);
learnprice_region(:,4) = learnprice_region1(11,4)./initialcost_ratio_country(:,2);
learnprice_region(:,5) = learnprice_region1(11,5)./initialcost_ratio_country(:,3);
learnprice_region(:,6) = learnprice_region1(11,6)./initialcost_ratio_country(:,3);
save('H:\Global PV and wind\ANS\learnprice_region_county0811_all_2_diffuse_pro112_8_2040xzsuper.mat','learnprice_region'); %
