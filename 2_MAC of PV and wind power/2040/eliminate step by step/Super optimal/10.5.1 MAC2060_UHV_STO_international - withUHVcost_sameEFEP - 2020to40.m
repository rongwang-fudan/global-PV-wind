...
save('H:\Global PV and wind\ANS\Cost_mechanical1_centralcase_county_all_pro2_8_2040_8_2040_2s_2020s_test6xzsuper.mat','Cost_mechanical1') 
...
Cost_storage=Cost_storage1;
clear Cost_storage1
save('H:\Global PV and wind\ANS\Cost_storage_centralcase_county_all_pro2_8_2040_2s_2020s_test6xzsuper.mat','Cost_storage') 
...
save('H:\Global PV and wind\ANS\Cost_sto_ini_centralcase_county_all_pro2_8_2040_2s_2020s_test6xzsuper.mat','Cost_sto_ini') 
save('H:\Global PV and wind\ANS\Cost_sto_OM_centralcase_county_all_pro2_8_2040_2s_2020s_test6xzsuper.mat','Cost_sto_OM') 
...
save('H:\Global PV and wind\ANS\lcoeeall_utilize_trans_storage_type2_8_2040_2s_2020s_test6xzsuper.mat','lcoeeall_utilize_trans_storage_type', '-v7.3')  % billion kWh / year
...
% end
% save('H:\Global PV and wind\ANS\emissionfactor_8_2040_2s_2020s_test6xzsuper.mat','emissionfactor', '-v7.3')  
% clear ixx_2_1
...
B_utilize_trans_storage(m,1) = Inf;
    B_m(m,1) = Inf;
save('H:\Global PV and wind\ANS\B_m_8_2040_2s_2020s_test6xzsuper.mat','B_m', '-v7.3')  % billion kWh / year
...
save('H:\Global PV and wind\ANS\LCOE_UHV_STO_INT_county_all_withUHVcost_pro2_8_2040_2s_2020s_test6xzsuper.mat','LCOEE_all_utilize_trans_storage', '-v7.3')  % billion kWh / year
cost_all_withUHVcost =  (sum(lcoeeall_utilize_trans_storage(:,1:11),2)); % million USD2019
save('H:\Global PV and wind\ANS\cost_all_withUHVcost_pro2_8_2040_2s_2020s_test6xzsuper.mat','cost_all_withUHVcost', '-v7.3')  % billion kWh / year
inicost_all_withUHVcost =  (sum(lcoeeall_utilize_trans_storage(:,1:8),2)); % million USD2019
save('H:\Global PV and wind\ANS\inicost_all_withUHVcost_pro2_8_2040_2s_2020s_test6xzsuper.mat','inicost_all_withUHVcost', '-v7.3')  % billion kWh / year
phhall_utilize_trans_storage111 = phhall_utilize_trans_storage(:,1);
% save('H:\Global PV and wind\ANS\Ph_UHV_STO_reg2_8_2040_2s_2020s_test6xzsuper.mat','phhall_utilize_trans_storage111', '-v7.3')  % billion kWh / year
save('H:\Global PV and wind\ANS\Ph_UHV_STO_INT_county_all_withUHVcost_pro2_8_2040_2s_2020s_test6xzsuper.mat','phhall_utilize_trans_storage111', '-v7.3')  % billion kWh / year
phhall_utilize_trans_storage111_year = phhall_utilize_trans_storage111./degrat40yr_onshorewind(4,:)';
save('H:\Global PV and wind\ANS\Ph_UHV_STO_INT_year_county_all_withUHVcost_pro2_8_2040_2s_2020s_test6xzsuper.mat','phhall_utilize_trans_storage111_year', '-v7.3')  % billion kWh / year

cost = sum(lcoeeall_utilize_trans_storage(:,1:11),2); % million 2019 USD
% save('H:\Global PV and wind\ANS\costtt_UHV_STO_reg2_8_2040_2s_2020s_test6xzsuper.mat','cost', '-v7.3')  % 
save('H:\Global PV and wind\ANS\costtt_UHV_STO_INT_county_all_withUHVcost2_8_2040_2s_2020s_test6xzsuper.mat','cost', '-v7.3')  % million 2019 USD 
...
save('H:\Global PV and wind\ANS\cost_all_withUHVcost1004_pro2_8_2040_2s_2020s_test6xzsuper.mat','cost_all', '-v7.3')  % trillion 2019 USD
...
save('H:\Global PV and wind\ANS\CP_UHV_STO_INT_county_all_withUHVcost_pro2_8_2040_2s_2020s_test6xzsuper.mat','CP', '-v7.3')  % billion kWh / year
save('H:\Global PV and wind\ANS\CO2_UHV_STO_INT_county_all_withUHVcost_pro2_8_2040_2s_2020s_test6xzsuper.mat','CO2all_c_utilize_trans_storage', '-v7.3')  % billion kWh / year
save('H:\Global PV and wind\ANS\B_UHV_STO_INT_county_all_withUHVcost_pro2_8_2040_2s_2020s_test6xzsuper.mat','B_utilize_trans_storage', '-v7.3')  % billion kWh / year


save('H:\Global PV and wind\ANS\CO2_PV_year_STO_INT_county_all_withUHVcost_pro2_8_2040_2s_2020s_test6xzsuper.mat','CO2_PV_year', '-v7.3')  % billion kWh / year
save('H:\Global PV and wind\ANS\CO2_onshorewind_year_STO_INT_county_all_withUHVcost_pro2_8_2040_2s_2020s_test6xzsuper.mat','CO2_onshorewind_year', '-v7.3')  % billion kWh / year
save('H:\Global PV and wind\ANS\CO2_offshorewind_year_STO_INT_county_all_withUHVcost_pro2_8_2040_2s_2020s_test6xzsuper.mat','CO2_offshorewind_year', '-v7.3')  % billion kWh / year

% save('H:\Global PV and wind\ANS\CP_UHV_STO_reg2_8_2040_2s_2020s_test6xzsuper.mat','CP', '-v7.3')  % billion kWh / year
% save('H:\Global PV and wind\ANS\CO2_UHV_STO_reg2_8_2040_2s_2020s_test6xzsuper.mat','CO2all_c_utilize_trans_storage', '-v7.3')  % billion kWh / year
% save('H:\Global PV and wind\ANS\B_UHV_STO_reg2_8_2040_2s_2020s_test6xzsuper.mat','B_utilize_trans_storage', '-v7.3')  % billion kWh / year
% save('H:\Global PV and wind\ANS\CP_UHV_STO2_8_2040_2s_2020s_test6xzsuper.mat','CP', '-v7.3')  % billion kWh / year
% save('H:\Global PV and wind\ANS\CO2_UHV_STO2_8_2040_2s_2020s_test6xzsuper.mat','CO2all_c_utilize_trans_storage', '-v7.3')  % billion kWh / year
% save('H:\Global PV and wind\ANS\B_UHV_STO2_8_2040_2s_2020s_test6xzsuper.mat','B_utilize_trans_storage', '-v7.3')  % billion kWh / year

save('H:\Global PV and wind\ANS\CO2_UHV_STO_INT_pv_county_all_withUHVcost_pro2_8_2040_2s_2020s_test6xzsuper.mat','CO2all_c_utilize_trans_storage_pv', '-v7.3')  % billion kWh / year
save('H:\Global PV and wind\ANS\B_UHV_STO_INT_pv_county_all_withUHVcost_pro2_8_2040_2s_2020s_test6xzsuper.mat','B_utilize_trans_storage_pv', '-v7.3')  % billion kWh / year

save('H:\Global PV and wind\ANS\CO2_UHV_STO_INT_ons_county_all_withUHVcost_pro2_8_2040_2s_2020s_test6xzsuper.mat','CO2all_c_utilize_trans_storage_onshorewind', '-v7.3')  % billion kWh / year
save('H:\Global PV and wind\ANS\B_UHV_STO_INT_ons_county_all_withUHVcost_pro2_8_2040_2s_2020s_test6xzsuper.mat','B_utilize_trans_storage_onshorewind', '-v7.3')  % billion kWh / year

save('H:\Global PV and wind\ANS\CO2_UHV_STO_INT_off_county_all_withUHVcost_pro2_8_2040_2s_2020s_test6xzsuper.mat','CO2all_c_utilize_trans_storage_offshorewind', '-v7.3')  % billion kWh / year
save('H:\Global PV and wind\ANS\B_UHV_STO_INT_off_county_all_withUHVcost_pro2_8_2040_2s_2020s_test6xzsuper.mat','B_utilize_trans_storage_offshorewind', '-v7.3')  % billion kWh / year

B_utilize_trans_storage(B_utilize_trans_storage==-inf)=inf;
[B_utilize_trans_storage_IX,IX]=sort(B_utilize_trans_storage);
save('H:\Global PV and wind\ANS\IX_UHV_STO_INT_county_all_withUHVcost_pro2_8_2040_2s_2020s_test6xzsuper.mat','IX', '-v7.3')  % 
...
%%
save('H:\Global PV and wind\ANS\B22_utilize_trans_storage_IX22_8_2040_2s_2020s_test6xzsuper.mat','B22_utilize_trans_storage_IX2', '-v7.3')  % billion kWh / year
save('H:\Global PV and wind\ANS\CO2all2_c22_utilize_trans_storage_IX22_8_2040_2s_2020s_test6xzsuper.mat','CO2all2_c22_utilize_trans_storage_IX2', '-v7.3')  % billion kWh / year
...
save('H:\Global PV and wind\ANS\CO2_8_2040_2s_2020s_test6xzsuper.mat','CO2'); %
save('H:\Global PV and wind\ANS\MAC_8_2040_2s_2020s_test6xzsuper.mat','MAC'); %
save('H:\Global PV and wind\ANS\CO2_cum_8_2040_2s_2020s_test6xzsuper.mat','CO2_cum'); %

save('H:\Global PV and wind\ANS\optpowerunit_IX_8_2040_2s_2020s_test6xzsuper.mat','optpowerunit_IX'); %
save('H:\Global PV and wind\ANS\powerunit_country_IX_IX_8_2040_2s_2020s_test6xzsuper.mat','powerunit_country_IX_IX'); %
save('H:\Global PV and wind\ANS\emissionfactor_8_2040_2s_2020s_test6xzsuper.mat','emissionfactor'); %

phhall_all2 = phhall_utilize_trans_storage./degrat40yr_PV(4,:)';
% B_utilize_trans_storage = (sum(lcoeeall_utilize_trans_storage(:,1:11),2)-phhall_utilize_trans_storage(:,1).*EP*10^3)./(-CO2_all_utilize_trans_storage); %USD/t CO2
save('H:\Global PV and wind\ANS\phhall_all2_8_2040_2s_2020s_test6xzsuper.mat','phhall_all2', '-v7.3')  % TWh / year
save('H:\Global PV and wind\ANS\EP_8_2040_2s_2020s_test6xzsuper.mat','EP', '-v7.3')  % billion kWh / year
save('H:\Global PV and wind\ANS\CO2_year_utilize_trans_storage_8_2040_2s_2020s_test6xzsuper.mat','CO2_year_utilize_trans_storage', '-v7.3')  % Mt CO2/year
...
save('H:\Global PV and wind\ANS\lcoeeall_component_8_2040_2s_2020s_test6xzsuper.mat','lcoeeall_component', '-v7.3')  %
save('H:\Global PV and wind\ANS\EP_8_2040_2s_2020s_test6xzsuper.mat','EP', '-v7.3')  % billion kWh / year
