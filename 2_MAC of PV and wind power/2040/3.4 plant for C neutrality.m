...
load('H:\Global PV and wind\ANS\etrans_cou1_num_1023_pro2_8_2070.mat')
etrans_t = sum(sum(etrans_cou1_num,3),2);
load('H:\Global PV and wind\ANS\powerunit_country_IX_IX_8_2070_2s_2060s_test6.mat'); % powerunit_country_IX_IX
...
load('H:\Global PV and wind\Data\P2030_others_xz.mat') 
% 1.Biomass; 2.Geothermal; 3.Hydro; 4.Nuclear; 5.Ocean;
load('H:\Global PV and wind\Data\P2019_others_xz.mat')
...
PD(:,4) = PD2040;
load('H:\Global PV and wind\Data\P2040_others_xz.mat') 
...
PD(:,6) = PD2050;
load('H:\Global PV and wind\Data\P2050_others_xz.mat') 
...
save('H:\Global PV and wind\ANS\P_others2040_8_2s.mat','P_others'); %
save('H:\Global PV and wind\ANS\unitmin2040_8_2s_1.mat','unitmin'); %
save('H:\Global PV and wind\ANS\country_needadjust2040_8_2s.mat','country_needadjust'); %
