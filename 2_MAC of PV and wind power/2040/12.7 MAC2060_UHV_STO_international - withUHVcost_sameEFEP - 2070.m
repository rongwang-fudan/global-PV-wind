...
load('H:\global-PV-wind\ANS\cho_county_all_pro2_8_2070_xz_2040C.mat'); % % 0是无需储能，1是机械储能，-1是化学储能
...
load('H:\global-PV-wind\ANS\cost_trans_8_2040_xzxz.mat')% million $和optpowerunit_IX顺序一样
load('H:\global-PV-wind\ANS\CP_trans_8_2040_xzxz.mat')% MW

load('H:\global-PV-wind\ANS\utilize_ratio_8_2040_xzxz.mat')  % power use efficiency with global electric transport and storage
...
load('H:\global-PV-wind\ANS\storage_max_plant_8_2040_xzxz.mat')   % Maximum charging power, TWh/h
load('H:\global-PV-wind\ANS\storage_year_plant_8_2040_xzxz.mat')  % Average annual electricity storage, TWh/year
...
save('H:\global-PV-wind\ANS\Cost_mechanical1_centralcase_county_all_pro2_8_2040_8_2040_2s_2070_test6xz.mat','Cost_mechanical1')
...
%
load('H:\global-PV-wind\ANS\unitmin2040_8_2sxz.mat'); %% rIp=[595.73, 374.45, 327.22,280.78]./595.73;
unitmin_CHA = unitmin;
...
Cost_storage=Cost_storage1;
clear Cost_storage1
save('H:\global-PV-wind\ANS\Cost_storage_centralcase_county_all_pro2_8_2040_2s_2070_test6xz.mat','Cost_storage')
save('H:\global-PV-wind\ANS\Ip_storageall_8_2040_2s_2070_test6xz.mat','Ip_storageall')  % kw
...
save('H:\global-PV-wind\ANS\Cost_sto_ini_centralcase_county_all_pro2_8_2040_2s_2070_test6xz.mat','Cost_sto_ini')
save('H:\global-PV-wind\ANS\Cost_sto_OM_centralcase_county_all_pro2_8_2040_2s_2070_test6xz.mat','Cost_sto_OM')
save('H:\global-PV-wind\ANS\discount1yr_centralcase_county_all_pro2_8_2040_2s_2070_test6xz.mat','discount1yr')
clear discount1yr
...
save('H:\global-PV-wind\ANS\CP_trans_8_2040.mat','CP_trans') %  MW
save('H:\global-PV-wind\ANS\Ip_storageall_8_2040.mat','Ip_storageall') % kW
save('H:\global-PV-wind\ANS\Ie_storageall_8_2040.mat','Ie_storageall') % kWh
...
for nnna = 1:11
    [mm,nn]=find(unitmin_CHA==nnna);
    cost_trans22(mm,1) = cost_trans(mm).*learnprice_trans(nnna);
end

save('H:\global-PV-wind\ANS\cost_trans22_8_2040.mat','cost_trans22') % million $和optpowerunit_IX顺序一样
...
for ccc = 1:192
    ...
    aaaa(ccc,1) = sum(Ie_storageall(mmm));
    aaaa22(ccc,1) = sum(Ip_storageall(mmm));
end
aaaa/10^9 % TWh
...
load('H:\global-PV-wind\ANS\learnprice_region_county0811_all_2_pro22_8_2040xz.mat'); % 10 regions * 6
learnprice_region2_2(:,:,2) = learnprice_region;
load('H:\global-PV-wind\ANS\learnprice_region_county0811_all_2_pro32_8_2040xz.mat'); % 10 regions * 6
learnprice_region2_2(:,:,3) = learnprice_region;
load('H:\global-PV-wind\ANS\learnprice_region_county0811_all_2_pro42_8_2040xz.mat'); % 10 regions * 6
learnprice_region2_2(:,:,4) = learnprice_region;
load('H:\global-PV-wind\ANS\learnprice_region_county0811_all_2_pro52_8_2040xz.mat'); % 10 regions * 6
learnprice_region2_2(:,:,5) = learnprice_region;
load('H:\global-PV-wind\ANS\learnprice_region_county0811_all_2_pro62_8_2040xz.mat'); % 10 regions * 6
learnprice_region2_2(:,:,6) = learnprice_region;
load('H:\global-PV-wind\ANS\learnprice_region_county0811_all_2_pro72_8_2040xz.mat'); % 10 regions * 6
learnprice_region2_2(:,:,7) = learnprice_region;
load('H:\global-PV-wind\ANS\learnprice_region_county0811_all_2_pro82_8_2040xz.mat'); % 10 regions * 6
learnprice_region2_2(:,:,8) = learnprice_region;
load('H:\global-PV-wind\ANS\learnprice_region_county0811_all_2_pro92_8_2040xz.mat'); % 10 regions * 6
learnprice_region2_2(:,:,9) = learnprice_region;
load('H:\global-PV-wind\ANS\learnprice_region_county0811_all_2_pro102_8_2040xz.mat'); % 10 regions * 6
learnprice_region2_2(:,:,10) = learnprice_region;
load('H:\global-PV-wind\ANS\learnprice_region_county0811_all_2_pro112_8_2040xz.mat'); % 10 regions * 6
...
learnprice_region2_2 = ones(192,6,11);
load('H:\global-PV-wind\ANS\learnprice_region_county0811_all_2_diffuse_pro22_8_2040xz.mat'); % 10 regions * 6
learnprice_region2_2(:,:,2) = learnprice_region;
load('H:\global-PV-wind\ANS\learnprice_region_county0811_all_2_diffuse_pro32_8_2040xz.mat'); % 10 regions * 6
learnprice_region2_2(:,:,3) = learnprice_region;
load('H:\global-PV-wind\ANS\learnprice_region_county0811_all_2_diffuse_pro42_8_2040xz.mat'); % 10 regions * 6
learnprice_region2_2(:,:,4) = learnprice_region;
load('H:\global-PV-wind\ANS\learnprice_region_county0811_all_2_diffuse_pro52_8_2040xz.mat'); % 10 regions * 6
learnprice_region2_2(:,:,5) = learnprice_region;
load('H:\global-PV-wind\ANS\learnprice_region_county0811_all_2_diffuse_pro62_8_2040xz.mat'); % 10 regions * 6
learnprice_region2_2(:,:,6) = learnprice_region;
load('H:\global-PV-wind\ANS\learnprice_region_county0811_all_2_diffuse_pro72_8_2040xz.mat'); % 10 regions * 6
learnprice_region2_2(:,:,7) = learnprice_region;
load('H:\global-PV-wind\ANS\learnprice_region_county0811_all_2_diffuse_pro82_8_2040xz.mat'); % 10 regions * 6
learnprice_region2_2(:,:,8) = learnprice_region;
load('H:\global-PV-wind\ANS\learnprice_region_county0811_all_2_diffuse_pro92_8_2040xz.mat'); % 10 regions * 6
learnprice_region2_2(:,:,9) = learnprice_region;
load('H:\global-PV-wind\ANS\learnprice_region_county0811_all_2_diffuse_pro102_8_2040xz.mat'); % 10 regions * 6
learnprice_region2_2(:,:,10) = learnprice_region;
load('H:\global-PV-wind\ANS\learnprice_region_county0811_all_2_diffuse_pro112_8_2040xz.mat'); % 10 regions * 6
learnprice_region2_2(:,:,11) = learnprice_region;
clear learnprice_region
...
for region = 1:1:192
    ...
    for nnna = 1:11
        ...
        lcoee_PV_m(mm,1) = cost_PV_alone(mm,14)./disrate_PV(4,mm)'.*r_module_hardwarecost_pv(region,1) .*learnprice_region(region,1,nnna); % cost million USD
        % 2  substation
        ...
        lcoee_onshorewind_m(mm,1) = cost_onshorewind_alone(mm,14)./disrate_wind(4,mm)'.*r_module_hardwarecost_ons.*learnprice_region(region,3,nnna); % cost million USD
        % 2  substation
        ...
        lcoee_offshorewind_m(mm,1) = module_price_offshore.*CP_offshorewind_alone(mm,1).*learnprice_region(region,5,nnna); % cost million USD
        % 2  others
...
lcoeeall_utilize_trans_storage_m = lcoee_PV_m;
...
[m,n]=find(lcoee_onshorewind_m~=0);
lcoeeall_utilize_trans_storage_m(sub2ind(size(lcoeeall_utilize_trans_storage_m), m, n))= lcoee_onshorewind_m(sub2ind(size(lcoee_onshorewind_m), m, n));
...
[m,n]=find(lcoee_offshorewind_m~=0);
lcoeeall_utilize_trans_storage_m(sub2ind(size(lcoeeall_utilize_trans_storage_m), m, n))= lcoee_offshorewind_m(sub2ind(size(lcoee_offshorewind_m), m, n));
...
save('H:\global-PV-wind\ANS\lcoeeall_utilize_trans_storage_type2_8_2040_2s_2070_test6xz.mat','lcoeeall_utilize_trans_storage_type', '-v7.3')  % billion kWh / year
...
save('H:\global-PV-wind\ANS\emissionfactor_8_2040_2s_2070_test6xz.mat','emissionfactor', '-v7.3')
clear ixx_2_1
...
B_m = lcoeeall_utilize_trans_storage_m./(-CO2_all_utilize_trans_storage);
[m,n] = find(CO2_all_utilize_trans_storage==0);
B_utilize_trans_storage(m,1) = Inf;
B_m(m,1) = Inf;
save('H:\global-PV-wind\ANS\B_m_8_2040_2s_2070_test6xz.mat','B_m', '-v7.3')  % billion kWh / year
...
save('H:\global-PV-wind\ANS\LCOE_UHV_STO_INT_county_all_withUHVcost_pro2_8_2040_2s_2070_test6xz.mat','LCOEE_all_utilize_trans_storage', '-v7.3')  % billion kWh / year
cost_all_withUHVcost =  (sum(lcoeeall_utilize_trans_storage(:,1:11),2)); % million USD2019
save('H:\global-PV-wind\ANS\cost_all_withUHVcost_pro2_8_2040_2s_2070_test6xz.mat','cost_all_withUHVcost', '-v7.3')  % billion kWh / year
inicost_all_withUHVcost =  (sum(lcoeeall_utilize_trans_storage(:,1:8),2)); % million USD2019
save('H:\global-PV-wind\ANS\inicost_all_withUHVcost_pro2_8_2040_2s_2070_test6xz.mat','inicost_all_withUHVcost', '-v7.3')  % billion kWh / year
phhall_utilize_trans_storage111 = phhall_utilize_trans_storage(:,1);
% save('H:\global-PV-wind\ANS\Ph_UHV_STO_reg2_8_2040_2s_2070_test6xz.mat','phhall_utilize_trans_storage111', '-v7.3')  % billion kWh / year
save('H:\global-PV-wind\ANS\Ph_UHV_STO_INT_county_all_withUHVcost_pro2_8_2040_2s_2070_test6xz.mat','phhall_utilize_trans_storage111', '-v7.3')  % billion kWh / year
phhall_utilize_trans_storage111_year = phhall_utilize_trans_storage111./degrat40yr_onshorewind(4,:)';
save('H:\global-PV-wind\ANS\Ph_UHV_STO_INT_year_county_all_withUHVcost_pro2_8_2040_2s_2070_test6xz.mat','phhall_utilize_trans_storage111_year', '-v7.3')  % billion kWh / year

cost = sum(lcoeeall_utilize_trans_storage(:,1:11),2); % million 2019 USD
% save('H:\global-PV-wind\ANS\costtt_UHV_STO_reg2_8_2040_2s_2070_test6xz.mat','cost', '-v7.3')  %
save('H:\global-PV-wind\ANS\costtt_UHV_STO_INT_county_all_withUHVcost2_8_2040_2s_2070_test6xz.mat','cost', '-v7.3')  % million 2019 USD
...
save('H:\global-PV-wind\ANS\cost_all_withUHVcost1004_pro2_8_2040_2s_2070_test6xz.mat','cost_all', '-v7.3')  % trillion 2019 USD
...
save('H:\global-PV-wind\ANS\CP_UHV_STO_INT_county_all_withUHVcost_pro2_8_2040_2s_2070_test6xz.mat','CP', '-v7.3')  % billion kWh / year
save('H:\global-PV-wind\ANS\CO2_UHV_STO_INT_county_all_withUHVcost_pro2_8_2040_2s_2070_test6xz.mat','CO2all_c_utilize_trans_storage', '-v7.3')  % billion kWh / year
save('H:\global-PV-wind\ANS\B_UHV_STO_INT_county_all_withUHVcost_pro2_8_2040_2s_2070_test6xz.mat','B_utilize_trans_storage', '-v7.3')  % billion kWh / year


save('H:\global-PV-wind\ANS\CO2_PV_year_STO_INT_county_all_withUHVcost_pro2_8_2040_2s_2070_test6xz.mat','CO2_PV_year', '-v7.3')  % billion kWh / year
save('H:\global-PV-wind\ANS\CO2_onshorewind_year_STO_INT_county_all_withUHVcost_pro2_8_2040_2s_2070_test6xz.mat','CO2_onshorewind_year', '-v7.3')  % billion kWh / year
save('H:\global-PV-wind\ANS\CO2_offshorewind_year_STO_INT_county_all_withUHVcost_pro2_8_2040_2s_2070_test6xz.mat','CO2_offshorewind_year', '-v7.3')  % billion kWh / year

% save('H:\global-PV-wind\ANS\CP_UHV_STO_reg2_8_2040_2s_2070_test6xz.mat','CP', '-v7.3')  % billion kWh / year
% save('H:\global-PV-wind\ANS\CO2_UHV_STO_reg2_8_2040_2s_2070_test6xz.mat','CO2all_c_utilize_trans_storage', '-v7.3')  % billion kWh / year
% save('H:\global-PV-wind\ANS\B_UHV_STO_reg2_8_2040_2s_2070_test6xz.mat','B_utilize_trans_storage', '-v7.3')  % billion kWh / year
% save('H:\global-PV-wind\ANS\CP_UHV_STO2_8_2040_2s_2070_test6xz.mat','CP', '-v7.3')  % billion kWh / year
% save('H:\global-PV-wind\ANS\CO2_UHV_STO2_8_2040_2s_2070_test6xz.mat','CO2all_c_utilize_trans_storage', '-v7.3')  % billion kWh / year
% save('H:\global-PV-wind\ANS\B_UHV_STO2_8_2040_2s_2070_test6xz.mat','B_utilize_trans_storage', '-v7.3')  % billion kWh / year

save('H:\global-PV-wind\ANS\CO2_UHV_STO_INT_pv_county_all_withUHVcost_pro2_8_2040_2s_2070_test6xz.mat','CO2all_c_utilize_trans_storage_pv', '-v7.3')  % billion kWh / year
save('H:\global-PV-wind\ANS\B_UHV_STO_INT_pv_county_all_withUHVcost_pro2_8_2040_2s_2070_test6xz.mat','B_utilize_trans_storage_pv', '-v7.3')  % billion kWh / year

save('H:\global-PV-wind\ANS\CO2_UHV_STO_INT_ons_county_all_withUHVcost_pro2_8_2040_2s_2070_test6xz.mat','CO2all_c_utilize_trans_storage_onshorewind', '-v7.3')  % billion kWh / year
save('H:\global-PV-wind\ANS\B_UHV_STO_INT_ons_county_all_withUHVcost_pro2_8_2040_2s_2070_test6xz.mat','B_utilize_trans_storage_onshorewind', '-v7.3')  % billion kWh / year

save('H:\global-PV-wind\ANS\CO2_UHV_STO_INT_off_county_all_withUHVcost_pro2_8_2040_2s_2070_test6xz.mat','CO2all_c_utilize_trans_storage_offshorewind', '-v7.3')  % billion kWh / year
save('H:\global-PV-wind\ANS\B_UHV_STO_INT_off_county_all_withUHVcost_pro2_8_2040_2s_2070_test6xz.mat','B_utilize_trans_storage_offshorewind', '-v7.3')  % billion kWh / year

B_utilize_trans_storage(B_utilize_trans_storage==-inf)=inf;
[B_utilize_trans_storage_IX,IX]=sort(B_utilize_trans_storage);
save('H:\global-PV-wind\ANS\IX_UHV_STO_INT_county_all_withUHVcost_pro2_8_2040_2s_2070_test6xz.mat','IX', '-v7.3')  %
...
% % storage start
% plot(-ones(12,1)*CO2all_c2_utilize_trans_storage_IX2(Index_Ie,1)/10^3,y)
% CP_cumsum_all(Index_Ie(1,1),1)

% carbon neutralityetrans_cou1_num2_1023_pro
%%
save('H:\global-PV-wind\ANS\B22_utilize_trans_storage_IX22_8_2040_2s_2070_test6xz.mat','B22_utilize_trans_storage_IX2', '-v7.3')  % billion kWh / year
save('H:\global-PV-wind\ANS\CO2all2_c22_utilize_trans_storage_IX22_8_2040_2s_2070_test6xz.mat','CO2all2_c22_utilize_trans_storage_IX2', '-v7.3')  % billion kWh / year
figure
plot(B22_utilize_trans_storage_IX2,-CO2all2_c22_utilize_trans_storage_IX2./10^3)
hold on
% plot(cost_CO2_reduction5_utilize_trans_storage,CO2_reduction5_utilize_trans_storage,'.')
% hold on
axis([ -200 300 0 60]);
% set(gca,'xticklabel',[])
% set(gca,'xlabel',[])
...
save('H:\global-PV-wind\ANS\CO2_8_2040_2s_2070_test6xz.mat','CO2'); %
save('H:\global-PV-wind\ANS\MAC_8_2040_2s_2070_test6xz.mat','MAC'); %
save('H:\global-PV-wind\ANS\CO2_cum_8_2040_2s_2070_test6xz.mat','CO2_cum'); %

save('H:\global-PV-wind\ANS\optpowerunit_IX_8_2040_2s_2070_test6xz.mat','optpowerunit_IX'); %
save('H:\global-PV-wind\ANS\powerunit_country_IX_IX_8_2040_2s_2070_test6xz.mat','powerunit_country_IX_IX'); %
save('H:\global-PV-wind\ANS\lines_IX_IX_8_2040_2s_2070_test6xz.mat','lines_IX_IX'); %
save('H:\global-PV-wind\ANS\emissionfactor_8_2040_2s_2070_test6xz.mat','emissionfactor'); %

phhall_all2 = phhall_utilize_trans_storage./degrat40yr_PV(4,:)';
% B_utilize_trans_storage = (sum(lcoeeall_utilize_trans_storage(:,1:11),2)-phhall_utilize_trans_storage(:,1).*EP*10^3)./(-CO2_all_utilize_trans_storage); %USD/t CO2
save('H:\global-PV-wind\ANS\phhall_all2_8_2040_2s_2070_test6xz.mat','phhall_all2', '-v7.3')  % TWh / year
save('H:\global-PV-wind\ANS\EP_8_2040_2s_2070_test6xz.mat','EP', '-v7.3')  % billion kWh / year
save('H:\global-PV-wind\ANS\CO2_year_utilize_trans_storage_8_2040_2s_2070_test6xz.mat','CO2_year_utilize_trans_storage', '-v7.3')  % Mt CO2/year
...
save('H:\global-PV-wind\ANS\lcoeeall_component_8_2040_2s_2070_test6xz.mat','lcoeeall_component', '-v7.3')  %


degrat = degrat40yr_PV(4,:)';
save('H:\global-PV-wind\ANS\degrat_8_2040_2s_2070_test6xz.mat','degrat', '-v7.3')  %
