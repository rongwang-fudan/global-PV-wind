...
%%
load('H:\global-PV-wind\ANS\country_needadjust2040_8_2s.mat'); % country_needadjust
load('H:\global-PV-wind\ANS\unitmin2040_8_2s_1.mat'); % unitmin
unitmin_all = unitmin;
...
for iiaa = 1:size(country_needadjust,1)
    ...
    [m22,n]=find(powerunit_country_IX_IX==country & optpowerunit_IX_all(:,35)==3 & unitmin_all<=4);
    if ~isempty(m22)
            ...
            if size(optpowerunit_IX,1)>1
                        ...
                        for p2=0:1:(100-p1)
                            ...
                            for p3=0:1:(100-p1-p2)
                                ...
                                for p4=0:1:(100-p1-p2-p3)
                                    pene(4,1)=(p1+p2+p3+p4)/100; % peneratration ratio in 2040-2050
                ...
                if zerotracker_year_country(country)==2040
                    for p1=0:1:100
                        ...
                        pene=zeros(2,2);
                        pene(1,1)=p1/100; % peneratration ratio in 2020-2030
                        pene(2,1)=1; % peneratration ratio in 2040-2050
                        costall_PV=0;
                        costall_onshorewind=0;
                        costall_offshorewind=0;
                        cumulativecapacity=0;
                ...
                %             filename = strcat('H:\global-PV-wind\ANS\3unitmin_region',num2str(country),'_county0811_all_off_pro.mat');
...
save('H:\global-PV-wind\ANS\unit_offshorewind_global_2040.mat','unit_offshorewind_global');
